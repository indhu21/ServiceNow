...
//		}
	...
	public IncidentsListPage clickWIP(){
		...
		if(clickLink("INCMENU_WIP")){
			verifyData();
			Reporter_ServiceNow.reportStep("The Work In Progress link is clicked and All the respective Incident displayed as expected.", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The Work In Progress link is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public IncidentsListPage clickOpen(){
		...
		if(clickLink("INCMENU_OPEN")){
			verifyData();
			Reporter_ServiceNow.reportStep("The Open link is clicked and All the respective Incidents displayed as expected.", "SUCCESS");}
		else
	...
	public SPARCPortalPage clickSPARCPortal(){ 	
		...
		if(clickByXpath("SPARCPORTAL_Xpath"))
			Reporter_ServiceNow.reportStep("The SPARC Portal link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The SPARC Portal link is not found or clicked.", "FAILURE");
	...
	public MyProfilePage selectMyProfile(){ 
		...
		if(selectMenuFromMainHeader("Self_Service","My_Profile"))
			Reporter_ServiceNow.reportStep("The My Profile in Self-Service is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Profile in Self-Service not found or clicked.", "FAILURE");
	...
	public IncidentsListPage clickAssignedToMe(){
		...
		if(clickLink("INCMENU_ASSIGN")){
			verifyData();
			Reporter_ServiceNow.reportStep("The Assigned to me - menu is clicked and All the respective Incidents displayed as expected.", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The Assigned to me - menu is not found or clicked.", "FAILURE");
		clearFilter();
		return new IncidentsListPage(driver);
	}
	...
	public MenuPage VerifyIncidentMenuDoNotExists(){
		...
		if(IsElementNotPresentByXpath("INCMENU_Title"))
			Reporter_ServiceNow.reportStep("Incident Menu does not exist as expected for this user", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("Incident Menu exists for this user", "WARNING");
	...
	public IncidentsListPage clickOpenUnAssigned(){
		...
		if(clickLink("INCMENU_UNASSIGN"))
			Reporter_ServiceNow.reportStep("The Open - Unassigned link is clicked and all the respective incidents displayed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Open - Unassigned is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public IncidentsListPage clickAll(){
		...
		if(clickLink("INCMENU_ALL")){
			verifyData();
			Reporter_ServiceNow.reportStep("The ALL - menu is clicked and all the respective incident displayed as expected.", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The ALL - menu is not found or clicked.", "FAILURE");
		clearFilter();
		return new IncidentsListPage(driver);
	}
	public IncidentsListPage clickClosed(){
		...
		if(clickLink("INCMENU_CLOSED")){
			verifyData();
			Reporter_ServiceNow.reportStep("The Closed - menu is clicked and All the respective Incidents displayed as expected.", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The Closed - menu is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public IncidentsMapPage clickIncidentsMap(){
		...
		if(clickLink("INCMENU_CIM")){
			Reporter_ServiceNow.reportStep("The Critical Incidents Map menu is clicked", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The Critical Incidents Map menu is not found or clicked.", "FAILURE");
	...
	public IncidentPage searchIncident(String data) {
		...
		if (clickByXpath("INC_SetPriority_Xpath"))
			Reporter_ServiceNow.reportStep("The Incident: "+data+" is entered successfully in search box of the home page and The Set priority Icon is clicked sucessfully", "SUCCESS");
		else
	...
	public IncidentPage searchIncidentFromMenu(String data) {
		...
		// enter search    
		if(enterByXpathAndClick("INCMENU_TopSearch_Xpath", data))
			Reporter_ServiceNow.reportStep("The Incident: "+data+"is searched and opened as expected.", "SUCCESS");
		else	
			Reporter_ServiceNow.reportStep("Incident: "+data+" could not been entered in search box of the home page", "FAILURE");
	...
	public CmdbListPage clickSystemApplications(){
		...
		if(clickLink("CMDB_SA"))
			Reporter_ServiceNow.reportStep("The System/Applications link is clicked and All the respective CIs are listed as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The System/Applications link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickMyCMDBApprovals(){
		...
		if(clickLink("My_CMDB_Approvals"))
			Reporter_ServiceNow.reportStep("The My CMDB Approvals link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My CMDB Approvals link is not found or clicked.", "FAILURE");
	...
	public ViewRunPage clickViewRun(){
		...
		if(clickLink("View_Run"))
			Reporter_ServiceNow.reportStep("The View / Run is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The View / Run  is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public CmdbListPage clickOracle(){
		...
		if(clickLink("CMDB_Oracle"))
			Reporter_ServiceNow.reportStep("The Oracle link is clicked and All the respective CIs are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Oracle link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickWinserver(){
		...
		if(clickLink("CMDBServer_Windows"))
			Reporter_ServiceNow.reportStep("The Windows under Server link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Windows under Server link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickStoragePools(){
		...
		if(clickLink("StrPools_Pools"))
			Reporter_ServiceNow.reportStep("The Pools under Storage link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Pools under Storage link is not found or clicked.", "FAILURE");
	...
	public IncidentsListPage clickMissingCITasks(){
		...
		if(clickLink("MissingCITasks"))
			Reporter_ServiceNow.reportStep("The Missing CI Tasks link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Missing CI Tasks link is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public CmdbListPage clickPDUs(){
		...
		if(clickLink("CMDB_PDU"))
			Reporter_ServiceNow.reportStep("The PDU link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The PDU link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickControllers(){
		...
		if(clickLink("Storage_Controllers"))
			Reporter_ServiceNow.reportStep("The Controllers link is clicked successfully and A list of Storage Controller CIs appeared as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Controllers link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickNetworkSwitches(){
		...
		if(clickLink("NetworkSwitches"))
			Reporter_ServiceNow.reportStep("The Switches under Network link is clicked and All the respective CIs are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Switches under Network link is not found or clicked.", "FAILURE");
	...
	public IncidentsListPage clickMyGroupsWork(){
		...
		if(clickLink("MyGroupsWork"))
			Reporter_ServiceNow.reportStep("The My Groups Work - menu is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Groups Work - menu is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickMySPARCMessages(){
		...
		if(clickLink("PDUs_MySPARCMessages"))
			Reporter_ServiceNow.reportStep("The My SPARC Messages link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My SPARC Messages link could not be found or clicked.", "FAILURE");
	...
	public CmdbListPage clickCriticalAttributes(){
		...
		if(clickLink("CMDBControl_CriticalAttributes"))
			Reporter_ServiceNow.reportStep("The Critical Attributes link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Critical Attributes link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickUPS(){
		...
		if(clickLink("CMDB_UPS"))
			Reporter_ServiceNow.reportStep("The UPSs link is clicked", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The UPSs link is not found or clicked.", "FAILURE");
	...
	public ListPage clickSystemApplicationsAndVerifyNewButtonExists(){
		...
		if(isExistById("New_Button"))
			Reporter_ServiceNow.reportStep("The System/Applications link is clicked successfully and New button is available at the top of the list as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found", "FAILURE");
	...
	public SystemApplicationsPage clickSystemApplicationsandClickNewButton(){
		...
		if(clickById("New_Button"))
			Reporter_ServiceNow.reportStep("The System/Applications, New button is clicked sucessfully and New CI opened as expected", "SUCCESS");
		else
	...
	public CmdbListPage clickStoragePoolsPageAndVerifyNewButtonExists(){
		...
		if(isExistById("New_Button"))
			Reporter_ServiceNow.reportStep("The Pools under Storage link is clicked successfully and New button is available at the top of the list as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found", "FAILURE");
	...
	public ServerWindowsPage clickWinServerandClickNewButton(){
		...
		if(clickById("New_Button"))
			Reporter_ServiceNow.reportStep("The Windows under Server link and New button is clicked sucessfully, The New CI opened as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found or clicked", "FAILURE");
	...
	public OracleInstancesPage clickOracleandClickNewButton(){
		...
		if(clickById("New_Button"))
			Reporter_ServiceNow.reportStep("The Oracle link under DataBase and New button is clicked sucessfully, The New CI opened as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found or clicked", "FAILURE");
	...
	public NetworkSwitchesPage clickNetworkSwitchesandClickNewButton(){
		...
		if(clickById("New_Button"))
			Reporter_ServiceNow.reportStep("The Switches under Network link and New button is clicked sucessfully, The New CI opened as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found or clicked", "FAILURE");
	...
	public UPSPage clickUPSPageandClickNewButton(){
		...
		// Click create new
		if(!clickLink("CMDB_UPS"))
			Reporter_ServiceNow.reportStep("The UPS link is not found or clicked.", "FAILURE");
		switchToFrame("Frame_Main");

		if(clickById("New_Button"))
			Reporter_ServiceNow.reportStep("The UPS link and New button is clicked sucessfully, The New CI opened as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found or clicked", "FAILURE");
	...
	public CmdbListPage clickPDUAndVerifyNewButtonExists(){
		...
		if(isExistById("New_Button"))
			Reporter_ServiceNow.reportStep("The PDU link is clicked successfully and New button is available at the top of the list as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The New button could not been found", "FAILURE");
	...
	public ListPage clickOpenRecords(){
		...
		if(clickLink("Open_Records"))
			Reporter_ServiceNow.reportStep("The Open Records link is clicked and All the respective Tickets are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Open Records link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickLinux(){
		...
		if(clickLink("CMDBServer_Linux"))
			Reporter_ServiceNow.reportStep("The Linux link is clicked and All the respective CIs are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Linux link is not found or clicked.", "FAILURE");
	...
	public CmdbListPage clickServerAll(){
		...
		if(clickLink("CMDB_All"))
			Reporter_ServiceNow.reportStep("The ALL link is clicked and All the respective CIs are listed as expected", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The ALL - menu is not found or clicked.", "FAILURE");
		clearFilter();
	...
	public FSSTaskPage clickFSSTaskandNewButton()
	{
		...
		if (!clickLink("FSS_Tasks"))
			Reporter_ServiceNow.reportStep("The FSS Tasks - menu  is not found or clicked.","FAILURE");

		switchToMainFrame();

		if(clickById("FSS_FSSTasks_NewButton_Id"))
			Reporter_ServiceNow.reportStep("The FSS Tasks link is clicked and New FSS Task Page opened as expected.", "SUCCESS");
		else
	...
	public MyItemsPage clickMyItems()
	{
		...
		if (clickLink("My_Items"))
			Reporter_ServiceNow.reportStep("The My Items - menu selected successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Items - menu  is not found or clicked.","FAILURE");
	...
	public ListPage clickMyGroupWorksInFSS(){
		...
		// Click create new
		if(clickLink("MyGroupsWork"))
			Reporter_ServiceNow.reportStep("The My Groups Work link is clicked and All the respective Tickets are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Groups Work link is not found or clicked.", "FAILURE");
	...
	public MenuPage isIncidentMenuExists(String menu){
		...
		if(IsElementNotPresentByXpath(menu))
			Reporter_ServiceNow.reportStep("The Incident Menu does not appear as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Incident Menu does appear", "FAILURE");
	...
	public CmdbListPage clickMSSQL(){
		...
		if(clickLink("CMDB_MSSQL"))
			Reporter_ServiceNow.reportStep("The MSSQL link is clicked and All the respective CIs are listed as expected.", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The MSSQL link is not found or clicked.", "FAILURE");
	...
	public MenuPage verifyOverviewDashBoard(){
		...
		if (!selectMenuFromMainHeader("IncidentMenu", "INCMENU_OVERVIEW"))
			//			Reporter_ServiceNow.reportStep("The Overview  menu selected successfully","SUCCESS");
			//		else
			Reporter_ServiceNow.reportStep("The Alert Console  menu could not be selected","FAILURE");

		switchToMainFrame();

		if(IsElementPresentById("Incident_Overview_pagetitle_id"))
			Reporter_ServiceNow.reportStep("The Overview  menu is selected and the Incident Overview dashboard displayed as expected","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Incident Overview dashboard could not be displayed","FAILURE");
		return this;
	}
	...
	public IncidentsMapPage clickIncidentsMapandVerifyMapExists(){
		...
		if (isExistByXpath("INC_Map_Xpath")) {
			Wait(2000);
			Reporter_ServiceNow.reportStep("The Critical Incidents Map menu is clicked and Critical Incidents Map is displayed", "SUCCESS");}
		else
	...
	public SPARCPortalPage clickMyProfileofSPARCPortal(){ 	
		...
		if(clickByXpath("SPARCPORTAL_MyProfile_Xpath"))
			Reporter_ServiceNow.reportStep("The My Profile of SPARC Portal is clicked successfully", "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Profile of SPARC Portal could not be clicked", "FAILURE");
	...
	public IncidentPage clickOpenandClickFirstIncident(){
		...
		if(clickByXpath("ALERTPROFILE_FirstAlert_Xpath"))
			Reporter_ServiceNow.reportStep("The Open link is clicked and All the respective Incidents displayed and the First Incident is clicked Successfully", "SUCCESS");
		else
	...
	public AlertsListPage clickMyAlert(){
		...
		if(clickLink("My_Alerts"))
			Reporter_ServiceNow.reportStep("The My Alerts under OpsConsole - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The My Alerts under OpsConsole - menu could not be selected","FAILURE");
	...
	public AlertPage selectRunBookandUpdate(String alertId){
		...
		if(!selectByVisibleTextByXpath("ALERT_ReationType_Xpath", "Run Runbook"))
			Reporter_ServiceNow.reportStep("Create Incident for Alert "+ alertId +" could not be selected","FAILURE");

		if(!clickById("CIS_UpdateButton_Id"))
			Reporter_ServiceNow.reportStep("Update for Alert "+ alertId +" could not be clicked","FAILURE");
	...
	public AlertsListPage clickOpsAlertConsole(){
		...
		if(selectMenu("Ops_Consoles", "Alert_Console")){
			Reporter_ServiceNow.reportStep("The Alert Console under OpsConsole - menu selected successfully","SUCCESS");
//			verifyData();
		}
		else
	...
	public AlertsListPage selectScenarios(){
		...
		if(!enterById("filter_Id", "Ops Director Testing"))
			Reporter_ServiceNow.reportStep("Alert Console could not be entered in filter box","FAILURE");

		if(selectMenu("Ops_Director_Testing", "Scenarios"))
			Reporter_ServiceNow.reportStep("The Scenarios under Ops Director Testing - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Scenarios under Ops Director Testing - menu could not be selected","FAILURE");
	...
	public AlertsListPage selectData(){
		...
		if(!enterById("filter_Id", "Alerts"))
			Reporter_ServiceNow.reportStep("The Alerts could not be entered in filter box","FAILURE"); 

		if(selectMenu("Data", "Alerts"))
			Reporter_ServiceNow.reportStep("The Alerts under Data - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alert under Data - menu could not be selected","FAILURE");
	...
	public AlertPropertiesPage clickAdminApplicationProperties(){
		...
		if(selectMenu("Administration", "Application_Properties"))
			Reporter_ServiceNow.reportStep("The Application Properties under OpsConsole - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Application Properties under OpsConsole - menu could not be selected","FAILURE");
	...
	public AlertsListPage clickMyAlertConsole(){
		...
		if(selectMenu("Ops_Consoles", "My_Alert_Console"))
			Reporter_ServiceNow.reportStep("My Alerts Console under OpsConsole - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("My Alerts Console under OpsConsole - menu could not be selected","FAILURE");
	...
	public AlertsListPage clickUserAlertConsole(){
		...
		if(selectMenu("User_Consoles", "Alert_Console")){
			Reporter_ServiceNow.reportStep("The Alert Console link under User Consoles is clicked successfully","SUCCESS");
			}
		else
			Reporter_ServiceNow.reportStep("The Alert Console link under User Console is not clicked or not found.","FAILURE");
	...
	public AlertsEnrichersListPage clickAdminAlertEnrichers(){
		...
		if(selectMenu("Administration", "Alert_Enrichers"))
			Reporter_ServiceNow.reportStep("The Alert Enrichers link under Administration is clicked successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alert Enrichers link under Administration is not clicked or not found.","FAILURE");
	...
	public MenuPage playScenarios(String sceData){
		if(playScenario(sceData))
			Reporter_ServiceNow.reportStep(""+sceData+" under Scenario is clicked successful.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep(""+sceData+" under Scenario could not be clicked.","FAILURE");
	...
	public IncidentsListPage clickIncidents(){
		...
		if(clickLink("Incidents_Link"))
			Reporter_ServiceNow.reportStep("The Incidents link is clicked successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Incidents link is not clicked or not found.","FAILURE");
	...
	public AlertsListPage clickAlertsByState(){
		...
		if(clickLink("Alerts_By_State"))
			Reporter_ServiceNow.reportStep("The Alerts By State link is clicked successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alerts By State link is not clicked or not found.","FAILURE");
	...
	public AlertsSuppressorsListPage clickAlertSuppressors(){
		...
		if(clickLink("Alert_Suppressors"))
			Reporter_ServiceNow.reportStep("The Alert Suppressors link is clicked successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alert Suppressors link is not clicked or not found.","FAILURE");
	...
	public AlertsProfilesListPage clickAlertProfiles(){
		...
		if(selectMenu("Configurations", "Alert_Profiles"))
			Reporter_ServiceNow.reportStep("The Alert Profiles link is clicked successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alert Profiles link is not clicked or not found.","FAILURE");
	...
	public AlertDashBoardPage clickOPSAlertDashBoard(){
		...
		if(!enterById("filter_Id", "Ops Consoles"))
			Reporter_ServiceNow.reportStep("Ops Consoles could not be entered in filter box.","FAILURE");

		if(clickLink("Alert_Dashboard"))
			Reporter_ServiceNow.reportStep("The Alert Dashboard  link clicked successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Alert Dashboard link is not clicked or not found.","FAILURE");
	...
	public CIScopePage clickCIScope(){
		...
		if(clickLink("CIS_Registration"))
			Reporter_ServiceNow.reportStep("The CI Scope under Registration - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The CI Scope under Registration - menu is not selected or not found, hence failure.","FAILURE");
	...
	public CIScopesListPage clickCIScopes(){
		...
		if(selectMenu("Configurations", "CIS_Scopes"))
			Reporter_ServiceNow.reportStep("The CI Scopes under Configurations - menu selected successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The CI Scopes under Configurations - menu is not selected or not found.","FAILURE");
	...
	public String  getUserName() {
		...
		if(username.equals(""))
			Reporter_ServiceNow.reportStep("The User Name is blank.","FAILURE");
	...
	public AlertsListPage clickAlerts(){
		...
		if(selectMenu("Data", "Alerts"))
			...
			Reporter_ServiceNow.reportStep("The Alerts under Data - menu is not selected or not found.","FAILURE");
		return new AlertsListPage(driver);
	}
	...
	public AlertProfilePage clickAlertProfileRegistration(){
		...
		if (clickLink("Prof_Reg"))
			Reporter_ServiceNow.reportStep("The Profile Registration menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Profile Registration menu could not be selected or not found","FAILURE");
	...
	public CorrelationProfilesPage clickCorrelatedProfile() {
		...
		if (selectMenu("Ops_Director","Registration_Menu", "Correlated_Profile"))
			Reporter_ServiceNow.reportStep("The Correlated Profile - menu selected successfully","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Correlated Profile - menu could not be selected","FAILURE");
	...
	public AlertProfilePage clickAlertProfileRegistrationWithoutReport(){
		...
		if (!selectMenu("Ops_Director", "Registration", "Prof_Reg"))
			Reporter_ServiceNow.reportStep("The Profile Registration menu could not be selected","FAILURE");
	...
	public MenuPage clickAlertProfileRegistrationNegative(){
		...
		// Click create new
		if (!clickLink("Prof_Reg"))
			Reporter_ServiceNow.reportStep("The Profile Registration menu not found as expected.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Profile Registration menu selected, hence failure","FAILURE");
	...
	public TemplatesListPage clickTemplatesMenu(){
		...
		if (clickLink("Templates"))
			Reporter_ServiceNow.reportStep("The Templates selected menu is selected successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Templates is not selected, hence failure","FAILURE");
	...
	public RunbookListPage clickUnassignedMenu(){
		...
		if (clickLink("Unassigned"))
			Reporter_ServiceNow.reportStep("The Unassigned menu under Runbook is selected successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Unassigned menu under Runbook  is not selected, hence failure","FAILURE");
	...
	public RunbookListPage clickAssignedtomeMenu(){
		...
		if (clickLink("Assigned_to_me"))
			Reporter_ServiceNow.reportStep("The Assigned to me menu under Runbook is selected successfully.","SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The Assigned to me menu under Runbook  is not selected, hence failure","FAILURE");
	...
	public IncidentsListPage clickResolved(){
		...
		if(clickLink("INCMENU_RESOLVED")){
			verifyData();
			Reporter_ServiceNow.reportStep("The Resolved link is clicked and All the respective Incidents displayed as expected.", "SUCCESS");}
		else
			Reporter_ServiceNow.reportStep("The Work In Progress link is not found or clicked.", "FAILURE");
		clearFilter();
		return new IncidentsListPage(driver);
