...
public class SystemApplicationsPage extends ServiceNowWrappers{
	...
	public SystemApplicationsPage(RemoteWebDriver driver) {
		...
		if (!isExistByXpath("NavBar_Xpath")) {
			Reporter.reportStep("This is not System/Applications Page", "FAILURE");
		}
	...
	public SystemApplicationsPage selectGxP(String gxp) {
		if(selectByVisibleTextByXpath("SA_GxP_Xpath",gxp))
			Reporter.reportStep("The Value: "+gxp+" is selected in GxP successfully", "SUCCESS");
		else
			Reporter.reportStep("The Value: "+gxp+" could not be selected in GxP", "FAILURE");
		return this;
	}

	public SystemApplicationsPage selectSOX(String sox) {
		if(selectByVisibleTextByXpath("SA_SOX_Xpath", sox))
			Reporter.reportStep("The Value: "+sox+" is selected in SOX successfully", "SUCCESS");
		else
			Reporter.reportStep("The Value: "+sox+" could not be selected in SOX", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage selectEnvironment(String environment) {
		if(selectByVisibleTextByXpath("SA_Environment_Xpath", environment))
			Reporter.reportStep("The Value: "+environment+" is selected in Environment successfully", "SUCCESS");
		else
			Reporter.reportStep("The Value: "+environment+" could not be selected in Environment", "FAILURE");
		return this;
	}

	public SystemApplicationsPage enterAndChooseLocation(String location) {
		if(enterAndChoose("SA_Location_Xpath", location))
			Reporter.reportStep("The location: "+location+" is entered successfully", "SUCCESS");
		else
	...
	public SystemApplicationsPage selectBusinessCriticality(String businessCriticality) {
		if(selectByVisibleTextByXpath("SA_BusinessCriticality_Xpath", businessCriticality))
			Reporter.reportStep("The Value: "+businessCriticality+" is selected in Business Criticality", "SUCCESS");
		else
			Reporter.reportStep("The Value: "+businessCriticality+" could not be selected in Business Criticality", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage clickApprove() {
		...
		if(clickByXpath("Approve_Xpath"))
			Reporter.reportStep("The approved button is clicked successfully and the task approved as expected", "SUCCESS");
		else	
	...
	public SystemApplicationsPage clickLinkName(String linkName){
		...
		if(clickLink(linkName, false))
			...
			Reporter.reportStep("The Value: "+ linkName +" under Configuration Item could not be clicked", "WARNING");
	...
	public SystemApplicationsPage verifyEnteredFileds( String businessCriticality,String sox, String gxp, String location, String environment){	
		...
		if(!(getDefaultValueByXpath("SA_BusinessCriticality_Xpath")).equals(businessCriticality))			
			Reporter.reportStep("The "+businessCriticality+" is NOT available Business Criticality","FAILURE");

		if(!(getDefaultValueByXpath("SA_SOX_Xpath")).equals(sox))			
			Reporter.reportStep("The "+sox+" is NOT available sox","FAILURE");

		if(!(getDefaultValueByXpath("SA_GxP_Xpath")).equals(gxp))			
			Reporter.reportStep("The "+gxp+" is NOT available Gxp","FAILURE");

		if(!(getAttributeByXpath("SA_Location_Xpath","value")).equals(location))
			Reporter.reportStep("The  "+location+" is NOT available in Location","FAILURE");

		if((getDefaultValueByXpath("SA_Environment_Xpath")).contains(environment))
			Reporter.reportStep("The values Business Criticality: "+businessCriticality+", SOX: "+sox +", GXP: "+gxp+", Location: "+location+", Environment: "+environment+" are matched as expected", "SUCCESS");
		else
			Reporter.reportStep("The  "+environment+" is NOT available in Location","FAILURE");
	...
	public SystemApplicationsPage addFifthFilter(String filterType, String filterValue){
		if(addFilters("CIS_FirstFilterType5_Xpath", filterType, "CIS_FilterCondition5_Xpath", filterValue))
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterValue +" is selected successfully", "SUCCESS");
		else					
	...
	public SystemApplicationsPage addSecondFilter(String filterType, String filterCondition){
		if(addFilters("CIS_FirstFilterType2_Xpath", filterType, "CIS_FilterCondition2_Xpath", filterCondition))
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterCondition+" "+" is selected successfully", "SUCCESS");
		else					
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterCondition+" "+" could not be selected","FAILURE");
	...
	public SystemApplicationsPage clickBusinessFunctionsTab() {
		...
		if(clickByXpath("SA_BusinessFuntionTab_Xpath"))
			Reporter.reportStep("The Business Functions Tab is selected successfully", "SUCCESS");
		else	
			Reporter.reportStep("The Business Functions Tab could not be clicked or not found", "FAILURE");
		return this;
	}	
	...
	public SystemApplicationsPage clickGroupsTab() {
		...
		if(clickByXpath("SA_GroupsTab_Xpath"))
			Reporter.reportStep("The Groups Tab is selected successfully", "SUCCESS");
		else	
			Reporter.reportStep("The Business Functions Tab could not be clicked or not found", "FAILURE");
		return this;
	}	
	...
	public SystemApplicationsPage clickTechnologyEnablersTab() {
		...
		if(clickByXpath("SA_TechnologyTab_Xpath")){
			Wait(5000);
			Reporter.reportStep("The Technology Enablers Tab is selected successfully", "SUCCESS");}
		else	
			Reporter.reportStep("The Technology Enablers Tab could not be clicked or not found", "FAILURE");
		return this;	}	
	...
	public SystemApplicationsPage clickDepartmentsTab() {
		...
		if(clickByXpath("SA_DepartmentsTab_Xpath"))
			Reporter.reportStep("The Departments Tab is selected successfully", "SUCCESS");
		else	
			Reporter.reportStep("The Departments Tab could not be clicked or not found", "FAILURE");
		return this;
	}	
	...
	public SystemApplicationsPage verifyRelatedLinks(){
		...
		if(!selectByIndexByXpath("SA_AvailableList_Xpath",0))
			Reporter.reportStep("The "+optionValues[0]+" select value could not be selected", "FAILURE");


		if(clickByXpath("ALERT_MoveBreach_ToSelected_Xpath"))
			Reporter.reportStep("The Highlighted CI appeared in the box on the right as expected", "SUCCESS");
		else
			Reporter.reportStep("The Right Arrow could not be clicked or not found", "FAILURE");
		...
		if(!verifyAllText("ALERT_FirstAlert_Xpath", value))
			Reporter.reportStep("The Save Button is clicked successfully and The Related Item: "+optionValues[0]+" was not added to the Related Links.", "FAILURE");
		else{
			Wait(2000);
			Reporter.reportStep("The Related Item: "+optionValues[0]+" appeared under the Related Links as expected.", "SUCCESS");
		}
		return this;
	...
	public SystemApplicationsPage verifyRelatedLinksforTec(){
		...
		if(clickByXpath("ALERT_MoveBreach_ToSelected_Xpath"))
			Reporter.reportStep("The First Highlighted CI appeared in the box on the right as expected", "SUCCESS");
		else
			Reporter.reportStep("The Right Arrow could not be clicked or not found", "FAILURE");
		...
		if(clickByXpath("ALERT_MoveBreach_ToSelected_Xpath"))
			Reporter.reportStep("The Second Highlighted CI appeared in the box on the right as expected", "SUCCESS");
		else
			Reporter.reportStep("The Right Arrow could not be clicked or not found", "FAILURE");
		...
		scrollToElementByXpath("SA_TechnologyTab_Xpath");
		if(!verifyAllText("ALERT_FirstAlert_Xpath", value))
			Reporter.reportStep("The Multiple Related Item : "+optionValues[0]+" "+optionValues[1]+"was not added to the Related Links.", "FAILURE");
		else{
			Wait(2000);
			Reporter.reportStep("The Save Button is clicked successfully and The Multiple Related Item : "+optionValues[0]+" "+optionValues[1]+" are appeared under the Related Links as expected.", "SUCCESS");
		}
		return this;
	}
	...
	public SystemApplicationsPage clickEditButton1(){
		...
		if(clickByXpath("Edit_Button1_Xpath"))
			Reporter.reportStep("The Edit Button is clicked successfully and the Relationship Editor screen opened as expected.", "SUCCESS");
		else
			Reporter.reportStep("The Edit Button could not be clicked or not found", "FAILURE");
		return this;	}
	...
	public SystemApplicationsPage changeLevel(String linkName){
		...
		if(clickLink(linkName, false))
			Reporter.reportStep("The Value: "+ linkName +" under Group Tab is clicked successfully and the group configuration screen will opened as expected.", "SUCCESS");
		else	
			Reporter.reportStep("The Value: "+ linkName +" under Group Tab could not be clicked", "FAILURE");

		String value=getDefaultValueByXpath("SA_LevelSelect_Xpath");
		if(selectByVisibleTextByXpath("SA_LevelSelect_Xpath", "Level 1"))
			Reporter.reportStep("The Value: Level 1 is selected successfully.", "SUCCESS");
		else
			Reporter.reportStep("The Value: Level 1 could not be clicked.", "FAILURE");
		...
		if(clickById("Save_Button_Id"))
			Reporter.reportStep("The Save Button is clicked successfully and the level of the group updated on the related list.", "SUCCESS");
		else	
			Reporter.reportStep("The Save Button could not be clicked.", "FAILURE");
	...
	public SystemApplicationsPage enterFilter(String name) {
		if(enterByXpath("SA_DepartFilter_Xpath", name))
			Reporter.reportStep("The Value: "+name+" is entered in Collection Box successfully", "SUCCESS");
		else
			Reporter.reportStep("The Value: "+name+" not found / could not be entered", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage enterAndChooseSecSystem(String SecSystem) {
		if(enterAndChoose("SA_SecondarySystemManage_Xpath", SecSystem))
			Reporter.reportStep("The Secondary System Manager: "+SecSystem+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Secondary System Manager: "+SecSystem+" not found / could not be entered", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage clickSave(){
		...
		if(clickById("Save_Id"))
			Reporter.reportStep("The Save Button is successfully.", "SUCCESS");
		else
			Reporter.reportStep("The Save Button could not be clicked or not found", "FAILURE");
		return this;	}
	...
	public SystemApplicationsPage verifyErrorMess(){
		...
		if((getTextByXpath("SA_ErrorMess_Xpath")).contains("System Manager and Secondary System Manager can't be the same person"))
			Reporter.reportStep("An invalid update error is generated as expected.", "SUCCESS");
		else
			Reporter.reportStep("An invalid update error could be not be generate, check snapshot.", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage verifySecSystem(String secSystemManager){
		...
		if((getAttributeByXpath("SA_SecondarySystemManage_Xpath","value")).contains(secSystemManager))			
			Reporter.reportStep("The "+secSystemManager+" is matched in Secondary System Manager as expected.","SUCCESS");
		else
			Reporter.reportStep("The "+secSystemManager+" is NOT available Secondary System Manager.","FAILURE");
	...
	public SystemApplicationsPage verifyErrorMessage(){
		...
		if((getTextByXpath("ErrorMessage_Xpath")).contains("Proposal for CI modification already exists for"))
			Reporter.reportStep("The Error Message Proposal for CI modification already exists appeared as expected.", "SUCCESS");
		else
			Reporter.reportStep("The Error Message Proposal for CI modification already exists could not be generated, check snapshot.", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage isDeletButtonNotPresent(String userName){
		...
		if(IsElementNotPresentByXpath("Delete_Xpath"))
			Reporter.reportStep("The Delete button does not exist for the user: "+ userName + " as expected" , "SUCCESS");
		else
			Reporter.reportStep("The Delete button does exist for the user: "+ userName + ", check snapshot","FAILURE");	
	...
	public String getCMDBName() {
		...
		if(CMDBTaskName.equals(""))
			Reporter.reportStep("The task Name is blank for newly created CMDB Task", "FAILURE");
		return CMDBTaskName;
	}	
	...
	public SystemApplicationsPage verifySecSystemError(){
		...
		if((getTextByXpath("ErrorMessage_Xpath")).contains("Proposal for CI modification already exist"))			
			Reporter.reportStep("The Error Message Proposal for CI modification already exist is generated as expected.","SUCCESS");
		else
			Reporter.reportStep("The Error Message could not be generated, Check snapshot.","FAILURE");
	...
	public SystemApplicationsPage enterAndChooseBusinessProcessOwner(String businessProcessOwner) {
		if(enterAndChoose("SA_BusinessProcessOwner_Xpath", businessProcessOwner))
			Reporter.reportStep("The Business Process Owner: "+businessProcessOwner+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Business Process Owner:: "+businessProcessOwner+" not found / could not be entered", "FAILURE");
		return this;
	...
	public SystemApplicationsPage getAlertMessage(String errorMessage) {
		if (getTextAndAcceptAlert().contains(errorMessage)) {
			Wait(3000);
			Reporter.reportStep("The Set Active button is clicked and The error message :" + errorMessage + " appeared as expected", "SUCCESS");
		} else
	...
	public SystemApplicationsPage enterAndChooseQAOwner(String qaOwner) {
		if(enterAndChoose("SA_QAOwner_Xpath", qaOwner))
			Reporter.reportStep("The QA Owner: "+qaOwner+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The QA Owner: "+qaOwner+" not found / could not be entered", "FAILURE");
		return this;
	...
	public SystemApplicationsPage enterAndChooseValidationLead(String validationlead) {
		if(enterAndChoose("SA_ValidationLead_Xpath", validationlead))
			Reporter.reportStep("The Validation Lead: "+validationlead+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Validation Lead: "+validationlead+" not found / could not be entered", "FAILURE");
		return this;
	...
	public SystemApplicationsPage isAddCIRelationshipExists() {
		...
		if(IsElementNotPresentByXpath("SA_AddCIRelationship_Xpath"))
			Reporter.reportStep("The Add CI Relationship icon is not available to establish relationships when the operational status is Decommissioned", "SUCCESS");
		else	
			Reporter.reportStep("The Add CI Relationship icon could is available", "FAILURE");
	...
	public SystemApplicationsPage enterAllMandatoryFields(String name,String CIOwnerGroup,String systemManager) {
		...
		if(enterAndChoose("SA_SystemManager_Xpath", systemManager))
			Reporter.reportStep("All the Mandatory fields Name: "+name+", CI OwnerGroup: "+CIOwnerGroup+", System Manager: "+systemManager+" are entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The System Manager: "+systemManager+" not found / could not be entered", "FAILURE");
		return this;
	...
	public SystemApplicationsPage verifyCMDBTaskInformation(String task) {
		...
		if(!text1.equals("manufacturer"))
			Reporter.reportStep("The Attribute value: "+text1+" could not be matched with manufacturer, hence failed", "FAILURE");

		if(!text2.equals(""))
			Reporter.reportStep("The Old Value: "+text2+" could not be matched with as empty, hence failed", "FAILURE");

		if(!text3.equals("Cisco"))
			Reporter.reportStep("The New Value: "+text3+" could not be matched with Cisco, hence failed", "FAILURE");

		if(getTextByXpath("ListPage_ReconciliationCIsAll_Xpath").contains(task))
			Reporter.reportStep("The CMDB Task number as "+task+", Attribute as manufacturer, Old Value as empty and New Value as Cisco are matched as expected.", "SUCCESS");
		else
			Reporter.reportStep("The CMDB Task could not be matched, hence failed", "FAILURE");
	...
	public SystemApplicationsPage enterandChooseManufacturer(String manufacturer) {
		if(enterAndChoose("SA_Manufacturer_Xpath", manufacturer))
			Reporter.reportStep("The Manufacturer: "+manufacturer+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Manufacturer: "+manufacturer+" not found / could not be entered", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage sysAppPageValues(String gxp, String sox, String environment, String location, String businessCriticality) {
		if(!selectByVisibleTextByXpath("SA_GxP_Xpath",gxp))
			Reporter.reportStep("The type: "+gxp+" could not be selected in GxP", "FAILURE");
		if(!selectByVisibleTextByXpath("SA_SOX_Xpath", sox))
			Reporter.reportStep("The type: "+sox+" could not be selected in SOX", "FAILURE");
		if(!selectByVisibleTextByXpath("SA_Environment_Xpath", environment))
			Reporter.reportStep("The type: "+environment+" could not be selected in Environment", "FAILURE");
		if(!enterAndChoose("SA_Location_Xpath", location))
			Reporter.reportStep("The location: "+location+" not found / could not be entered", "FAILURE");
		if(selectByVisibleTextByXpath("SA_BusinessCriticality_Xpath", businessCriticality))
			Reporter.reportStep("The Values GxP: "+gxp+", SOX: "+sox+", Environment: "+environment+", Location: "+location+", Business Criticality: "+businessCriticality+" are filled in respective fields as expected.", "SUCCESS");
		else
			Reporter.reportStep("The type: "+businessCriticality+" could not be selected in Business Criticality", "FAILURE");
	...
	public SystemApplicationsPage addFilterForCAR2_2(String filterType, String filterCondition, String filterValue1,String filterValue2, String filterValue3, String filterValue4){
		...
		if(!addFilters("CIS_FirstFilterType1_Xpath", filterType, "CIS_FilterCondition1_Xpath", filterCondition, "CIS_FilterValueSelect1_Xpath", filterValue1))
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterCondition+" "+ filterValue1 +" could not be selected","FAILURE");
		if(!clickByXpath("CIS_ORCondition_Xpath"))				
			Reporter.reportStep("The OR button  could not be clicked or not found", "FAILURE");
		if(!addFilters("CIS_FirstFilterType2_Xpath", filterType, "CIS_FilterCondition2_Xpath", filterCondition, "CIS_FilterValue2_Xpath", filterValue2))
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterCondition+" "+ filterValue2 +" could not be selected","FAILURE");
		if(!clickByXpath("CIS_ORCondition_Xpath"))				
			Reporter.reportStep("The OR button  could not be clicked or not found", "FAILURE");
		if(!addFilters("CIS_FirstFilterType3_Xpath", filterType, "CIS_FilterCondition3_Xpath", filterCondition, "CIS_FilterValue3_Xpath", filterValue3))
			Reporter.reportStep("The Filter value "+ filterType+" "+ filterCondition+" "+ filterValue3 +" could not be selected","FAILURE");
		if(!clickByXpath("CIS_ORCondition_Xpath"))				
			Reporter.reportStep("The OR button  could not be clicked or not found", "FAILURE");
		if(addFilters("CIS_FirstFilterType4_Xpath", filterType, "CIS_FilterCondition4_Xpath", filterCondition, "CIS_FilterValue4_Xpath", filterValue4))
			Reporter.reportStep("The Class value: "+ filterValue1+","+ filterValue2+","+filterValue3+", "+ filterValue4 +" are setted successfully", "SUCCESS");
		else					
			Reporter.reportStep("The Filter value: "+ filterType+" "+ filterCondition+" "+ filterValue4 +" could not be selected","FAILURE");
	...
	public SystemApplicationsPage enterAllOtherFields(String gxp, String sox, String environment, String location, String businessCriticality, String businessProcessOwner) {
		...
		if(!selectByVisibleTextByXpath("SA_BusinessCriticality_Xpath", businessCriticality))
			Reporter.reportStep("The type: "+businessCriticality+" could not be selected in Business Criticality", "FAILURE");
		if(enterAndChoose("SA_BusinessProcessOwner_Xpath", businessProcessOwner))
			Reporter.reportStep("The GxP: "+gxp+" , Sox: "+sox+" , Location: "+location+",Environment: "+environment+",Business Criticality: "+businessCriticality+",Business Process Owner: "+businessProcessOwner+" are entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Business Process Owner:: "+businessProcessOwner+" not found / could not be entered", "FAILURE");
		return this;
	}
	public SystemApplicationsPage enterAndChooseQAOwnerAndValidationLead(String qaOwner, String validationlead) {
		if(!enterAndChoose("SA_QAOwner_Xpath", qaOwner))
			Reporter.reportStep("The QA Owner: "+qaOwner+" not found / could not be entered", "FAILURE");
		if(enterAndChoose("SA_ValidationLead_Xpath", validationlead))
			Reporter.reportStep("The QA Owner: "+qaOwner+" and Validation Lead: "+validationlead+" are entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The Validation Lead: "+validationlead+" not found / could not be entered", "FAILURE");
		return this;
	}
	...
	public SystemApplicationsPage addFilterForCAR2_3DependsOn(String filterType, String filterCondition, String filterValue1,String filterValue2, String filterValue3, String filterValue4, String filterType5, String filterCondition5,String filterType6, String filterCondition6 ){
		...
		if(!addFilters("CIS_FirstFilterType5_Xpath", filterType5, "CIS_FilterCondition5_Xpath", filterCondition5))
			Reporter.reportStep("The Filter value "+ filterType5+" "+ filterCondition5 +" could not be selected","FAILURE");
		if(!clickByXpath("CIS_AndCondition1_Xpath"))				
			Reporter.reportStep("The AND button  could not be clicked or not found", "FAILURE");
		if(addFilters("CIS_FirstFilterType6_Xpath", filterType6, "CIS_FilterCondition6_Xpath", filterCondition6))
			Reporter.reportStep("The Class value: "+ filterValue1+","+ filterValue2+","+filterValue3+", "+ filterValue4 +" and "+ filterType5+" "+ filterCondition5 +" and "+filterType6+" "+filterCondition6+" are selected successfully", "SUCCESS");
		else					
			Reporter.reportStep("The Filter value "+ filterType6+" "+ filterCondition6 +" could not be selected","FAILURE");
	...
	public SystemApplicationsPage addFilterForCAR2_3UsedBy(String filterType1, String filterCondition1, String filterValue1, String filterType2, String filterCondition2,String filterType3, String filterCondition3){
		...
		if(!addFilters("CIS_FirstFilterType2_Xpath", filterType2, "CIS_FilterCondition2_Xpath", filterCondition2))
			Reporter.reportStep("The Filter value "+ filterType2+" "+ filterCondition2+" could not be selected","FAILURE");
		if(!clickByXpath("CIS_AndCondition1_Xpath"))				
			Reporter.reportStep("The AND button could not be clicked or not found", "FAILURE");
		if(addFilters("CIS_FirstFilterType3_Xpath", filterType3, "CIS_FilterCondition3_Xpath", filterCondition3))
			Reporter.reportStep("The Filter value: "+ filterType1+" "+ filterCondition1+" "+ filterValue1 +","+ filterType2+" "+ filterCondition2+" ,"+filterType3+" "+filterCondition3+" are selected successfully", "SUCCESS");
		else					
			Reporter.reportStep("The Filter value "+ filterType3+" "+ filterCondition3+" could not be selected","FAILURE");
	...
	public SystemApplicationsPage enterGxpSoxBusinessValues(String gxp, String sox, String business)
	{
		...
		if(!selectByVisibleTextByXpath("SA_GxP_Xpath", gxp))
			Reporter.reportStep("The GxP Value could not be selected with "+gxp+", hence failure", "FAILURE");
		if(!selectByVisibleTextByXpath("SA_SOX_Xpath", sox))
			Reporter.reportStep("The SOX Value could not be selected with "+sox+", hence failure", "FAILURE");
		if(selectByVisibleTextByXpath("SA_BusinessCriticality_Xpath", business))
			Reporter.reportStep("The Values GxP:"+gxp+", SOX: "+gxp+", Business Criticality: "+business+" are selected successfully.", "FAILURE");
		else
			Reporter.reportStep("The Business Criticality Value could not be selected with "+business+" hence failure", "FAILURE");
	...
	public SystemApplicationsPage VerifyGxpValue(String gxp)
	{
		if((getDefaultValueByXpath("SA_GxP_Xpath")).equals(gxp))
			...
			Reporter.reportStep("The GxP value :"+gxp+" could not matched, hence failure", "WARNING");
		return this;
	}
	...
	public SystemApplicationsPage verifySOXGxPBusinessCriticalityFileds( String sox, String gxp,String businessCriticality){	
		...
		if((getDefaultValueByXpath("SA_GxP_Xpath")).equals(gxp))			
			Reporter.reportStep("The values Business Criticality: "+businessCriticality+", SOX: "+sox +", GXP: "+gxp+" are matched as expected", "SUCCESS");
		else
			Reporter.reportStep("The  "+gxp+" is NOT available in GXP","FAILURE");
	...
	public SystemApplicationsPage sysAppPageValues1(String gxp, String sox, String location, String businessCriticality) {
		...
		if(!enterAndChoose("SA_Location_Xpath", location))
			Reporter.reportStep("The location: "+location+" not found / could not be entered", "FAILURE");
		if(selectByVisibleTextByXpath("SA_BusinessCriticality_Xpath", businessCriticality))
			Reporter.reportStep("The Values GxP: "+gxp+", SOX: "+sox+", Location: "+location+", Business Criticality: "+businessCriticality+" are filled in respective fields as expected.", "SUCCESS");
		else
			Reporter.reportStep("The type: "+businessCriticality+" could not be selected in Business Criticality", "FAILURE");
	...
	public SystemApplicationsPage clickSaveAndverifyErrorMessage(){
		...
		if((getTextByXpath("ErrorMessage_Xpath")).contains("Proposal for CI modification already exists for"))
			Reporter.reportStep("The Save Button is cliced successfully and The Error Message Proposal for CI modification already exists appeared as expected.", "SUCCESS");
		else
			Reporter.reportStep("The Error Message Proposal for CI modification already exists could not be generated, check snapshot.", "FAILURE");
		return this;
	}	
	...
	public SystemApplicationsPage sysAppPageValuesAndSave(String sox, String gxp, String businessCriticality) {
		if(!selectByVisibleTextByXpath("SA_GxP_Xpath",gxp))
			Reporter.reportStep("The type: "+gxp+" could not be selected in GxP", "FAILURE");
		if(!selectByVisibleTextByXpath("SA_SOX_Xpath", sox))
			Reporter.reportStep("The type: "+sox+" could not be selected in SOX", "FAILURE");
		...
		if(clickById("Save_Id"))
			Reporter.reportStep("The Values GxP: "+gxp+", SOX: "+sox+", Business Criticality: "+businessCriticality+" are filled in respective fields and Save Button is clicked as expected.", "SUCCESS");
		else
			Reporter.reportStep("The Save Button could not be clicked or not found", "FAILURE");
