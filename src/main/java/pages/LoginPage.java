...
//		  }
	...
	public MenuPage clickLoginwithoutReport() {
		clickById("LoginButton_Id");
		Wait(10000);
	...
	public MenuPage loginAswithoutreport(String username, String password) {
		return switchToMainFrame().
			   enterUsername(username).
			   enterPassword(password).
			   clickLoginwithoutReport();
	}
	public MenuPage clickLoginWithNormalsite() {
		...
		if (isExistById("Welcome_Id"))
			...
			Reporter.reportStep("The Login failed. Check snapshot", "FAILURE");
...
//		goOutOfFrame();
	...
	// Raj added on 7 th June of IMTC55
	 
	 public MenuPage loginSparcWithMyProfile(String username, String password) {
	  return switchToMainFrame().
	      enterUsername(username).
	      enterPassword(password).
	...
	public MenuPage clickLoginforSParcPortal1() {
