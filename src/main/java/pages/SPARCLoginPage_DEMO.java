...
public class SPARCLoginPage_DEMO extends ServiceNowWrappers {

	private final RemoteWebDriver driver;

	public SPARCLoginPage_DEMO() {
	...
	public SPARCLoginPage_DEMO switchToMainFrame(){
	...
	// field
	public SPARCLoginPage_DEMO enterUsername(String username) {
	...
	// field
	public SPARCLoginPage_DEMO enterPassword(String password) {
	...
	// The login page allows the user to submit the login form knowing that an
	// invalid username and / or password were entered
	public SPARCLoginPage_DEMO verifyErrorMessage(String errorMsg) {
		...
		return new SPARCLoginPage_DEMO();
	}

	// The login page allows the user to submit the login form knowing that an
	// invalid username and / or password were entered
	public SPARCLoginPage_DEMO clickLoginExpectingFailure() {
	...
	public SparcMenuPage_DEMO loginSPARC(String username, String password) {
		return switchToMainFrame().
			   enterUsername(username).
			   enterPassword(password).
			   clickSparcLogin();
	...
	public SparcMenuPage_DEMO clickSparcLogin() {
		clickById("LoginButton_Id");
		...
		// Return a new page object representing the menu page / home page
		return new SparcMenuPage_DEMO(driver);
	}
