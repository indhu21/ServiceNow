...
public class ServerWindowsPage extends ServiceNowWrappers{
	...
	public ServerWindowsPage(RemoteWebDriver driver) {
		...
		if (!isExistByXpath("NavBar_Xpath")) {
			Reporter.reportStep("This is not Windows Server Page", "FAILURE");
		}
	...
	public ServerWindowsPage enterAndChooseLocation(String location) {
		if(enterAndChoose("WinSer_Location_Xpath", location))
			Reporter.reportStep("The location: "+location+" is entered in Location", "SUCCESS");
		else
	...
	public ServerWindowsPage clickSetBuild() {
		...
		if(clickById("SA_Setbuild_Id"))
			Reporter.reportStep("The Set to Build button is clicked successfully and task is created and assigned to the System Manager as expected", "SUCCESS");
		else	
	...
	public String getCMDBTaskNumber() {
		...
		if(CMDBTaskNumber.equals(""))
			Reporter.reportStep("The CMDB task number is blank for newly created incident", "FAILURE");
	...
	public ServerWindowsPage clickAddCIRelationship() {
		...
		if(clickByXpath("SA_AddCIRelationship_Xpath"))
			Reporter.reportStep("The Add CI Relationship icon is clicked successfully", "SUCCESS");
		else	
	...
	public ServerWindowsPage clickSetRetire() {
		...
		if(clickById("SA_SetRetire_Id"))
			Reporter.reportStep("The Retire button is clicked successfully and task is created and assigned to the System Manager as expected.", "SUCCESS");
		else	
	...
	public ServerWindowsPage clickDecommission() {
		...
		if(clickById("SA_SetDecom_Id"))
			Reporter.reportStep("The Decommission button is clicked successfully and task is created and assigned to the System Manager as expected.", "SUCCESS");
		else	
	...
	public ServerWindowsPage clickSetActive() {
		...
		if(!clickById("SA_SetActive_Id"))
			...
			verifyAlert();
			Reporter.reportStep("The Set Active button is clicked successfully and task is created and assigned to the System Manager as expected.", "SUCCESS");}
	...
	public ServerWindowsPage verifyEnteredFileds( String sysManager, String CIOwnerGroup, String location, String environment){
		...
		if(!getAttributeByXpath("WinSer_SystemManager_Xpath","value").contains(sysManager))
			...
			if(!getAttributeByXpath("WinSer_CIOwnerGroup_Xpath","value").contains(CIOwnerGroup))
				Reporter.reportStep("The  "+CIOwnerGroup+" is NOT available in CI Owner Group","FAILURE");
		...
		if(getDefaultValueByXpath("WinSer_Environment_Xpath").contains( environment))
			Reporter.reportStep("The "+sysManager+","+CIOwnerGroup+","+location+","+environment+" are available in the fields as expected", "SUCCESS");
		else
			Reporter.reportStep("The "+environment+" is NOT available in Environment","FAILURE");
		return this;
	}
	...
	public ServerWindowsPage enterAllMandatoryFields(String name,String CIOwnerGroup,String systemManager) {
		...
		if(enterAndChoose("WinSer_SystemManager_Xpath", systemManager))
			Reporter.reportStep("All the Mandatory fields "+name+" ,"+CIOwnerGroup+" ,"+systemManager+" are entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The System Manager: "+systemManager+" not found / could not be entered", "FAILURE");
		return this;
	...
	public ServerWindowsPage selectEnvironmentAndLocation(String environment, String location) {
		if(!selectByVisibleTextByXpath("WinSer_Environment_Xpath", environment))
			Reporter.reportStep("The type: "+environment+" could not be selected in Environment", "FAILURE");
		if(enterAndChoose("WinSer_Location_Xpath", location))
			Reporter.reportStep("The "+environment+" and "+location+" are entered in Environment and Location as expected", "SUCCESS");
		else
			Reporter.reportStep("The location: "+location+" not found / could not be entered", "FAILURE");
		return this;
	}
	...
	public ServerWindowsPage addFilterForDependsOn(String filterType, String filterCondition, String filterValue1,String filterValue2, String filterValue3, String filterValue4, String filterType5, String filterCondition5,String filterType6, String filterCondition6 ){
		...
		if(addFilters("CIS_FirstFilterType6_Xpath", filterType6, "CIS_FilterCondition6_Xpath", filterCondition6))
			Reporter.reportStep("The Class values: "+ filterValue1+","+ filterValue2+","+filterValue3+", "+ filterValue4 +" and "+ filterType5+" "+ filterCondition5 +" and "+filterType6+" "+filterCondition6+" are setted successfully", "SUCCESS");
		else					
			Reporter.reportStep("The Class value "+ filterType6+" "+ filterCondition6 +" could not be selected","FAILURE");
	...
	public ServerWindowsPage addFilterForUsedBy(String filterType1, String filterCondition1, String filterValue1,String filterType2, String filterCondition2, String filterValue2, String filterType5, String filterCondition5,String filterType6, String filterCondition6){
		...
		if(addFilters("CIS_FirstFilterType4_Xpath", filterType6, "CIS_FilterCondition4_Xpath", filterCondition6))
			Reporter.reportStep("The Filter value: "+ filterType1+" "+ filterCondition1+" "+ filterValue1 +","+ filterValue2+","+filterType5+" "+filterCondition5+", "+filterType6+", "+filterCondition6+"  are selected successfully", "SUCCESS");
		else					
