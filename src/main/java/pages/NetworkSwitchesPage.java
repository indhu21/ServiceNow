...
public class NetworkSwitchesPage extends ServiceNowWrappers{
	...
	public NetworkSwitchesPage(RemoteWebDriver driver) {
		...
		if (!isExistByXpath("NavBar_Xpath")) {
			Reporter.reportStep("This is not Network Switches Page", "FAILURE");
		}
	}
	...
	public NetworkSwitchesPage selectGxP(String gxp) {
		if(selectByVisibleTextByXpath("NWSwitches_GxP_Xpath", gxp))
			Reporter.reportStep("The type: "+gxp+" is selected in GxP successfully", "SUCCESS");
		else
	...
	public NetworkSwitchesPage enterSerialNumber(String serialNumber) {
		if(enterByXpath("NWSwitches_SerialNumber_Xpath", serialNumber))
			Reporter.reportStep("The SerialNumber: "+serialNumber+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The SerialNumber: "+serialNumber+" not found / could not be entered", "FAILURE");
	...
	public NetworkSwitchesPage enterIPAddress(String IPAddress) {
		if(enterByXpath("NWSwitches_IPAddress_Xpath", IPAddress))
			Reporter.reportStep("The IP Address: "+IPAddress+" is entered successfully", "SUCCESS");
		else
			Reporter.reportStep("The IP Address: "+IPAddress+" not found / could not be entered", "FAILURE");
	...
	public NetworkSwitchesPage clickAddCIRelationship() {
		...
		if(clickByXpath("SA_AddCIRelationship_Xpath"))
			Reporter.reportStep("The Add CI Relationship icon is clicked successfully and relationship editor screen appeared as expected", "SUCCESS");
		else	
	...
	public NetworkSwitchesPage clickLinkName(String linkName){
		...
		if(clickLink(linkName, false))
			Reporter.reportStep("The Value: "+ linkName +" under Configuration Item could be clicked successfully", "SUCCESS");
		else	
	...
	public NetworkSwitchesPage verifyEnteredFileds( String gxp, String location, String ipAddress, String serialNumber){
		...
		if(!getAttributeByXpath("NWSwitches_IPAddress_Xpath","value").contains(ipAddress))
			Reporter.reportStep("The  "+ipAddress+" is NOT available in IP Address","FAILURE");		

		if(getAttributeByXpath("NWSwitches_SerialNumber_Xpath","value").contains(serialNumber))
			Reporter.reportStep("The Values GXP: "+gxp+", Location: "+location+", Ip Address: "+ipAddress+", Serial Number: "+serialNumber+" are matched as expected", "SUCCESS");
		else
			Reporter.reportStep("The  "+serialNumber+" is NOT available in IP Address","FAILURE");
		return this;
	}
	...
	public NetworkSwitchesPage fillOtherFields(String gxp, String location, String serialNumber, String IPAddress) {
		...
		if(!enterByXpath("NWSwitches_SerialNumber_Xpath", serialNumber))
			Reporter.reportStep("The SerialNumber: "+serialNumber+" not found / could not be entered", "FAILURE");
		if(enterByXpath("NWSwitches_IPAddress_Xpath", IPAddress))
			Reporter.reportStep("The Values GxP: "+gxp+", Location: "+location+", Serial Number: "+serialNumber+", IP Address: "+IPAddress+" are filled in respective fields successfully", "SUCCESS");
		else
			Reporter.reportStep("The IP Address: "+IPAddress+" not found / could not be entered", "FAILURE");
	...
	public NetworkSwitchesPage addFilterforTwoValues(String filterType1, String filterCondition1, String filterValue1, String filterValue2,
		...
		Reporter.reportStep("The Class values: "+filterType1+" "+filterCondition1+" "+ filterValue1+","+ filterValue2+", "+filterType3+" "+filterCondition3+", "+filterType4+" "+filterCondition4+" are selected successfully", "SUCCESS");
		return this;
	}
	public NetworkSwitchesPage addFilterforOneValues(String filterType1, String filterCondition1, String filterValue1, 
		...
		.clickANDCondition()
		.addthirdFilter(filterType3, filterCondition3);
		Reporter.reportStep("The Class values: "+filterType1+" "+filterCondition1+" "+ filterValue1+", "+filterType2+" "+filterCondition2+", "+filterType3+" "+filterCondition3+" are selected successfully", "SUCCESS");
		return this;
	}
	...
	public NetworkSwitchesPage verifyAddCIRelationship() {
		...
		if(isExistByXpath("SA_AddCIRelationship_Xpath"))
			Reporter.reportStep("The Add CI Relationship icon is appeared for Active CI as expected.", "SUCCESS");
		else	
			Reporter.reportStep("The Add CI Relationship icon is appeared, hence failure.", "FAILURE");
