...
//		if (!"ServiceNow".equals(driver.getTitle())){
...
//		goOutOfFrame();
	...
	public LoginPage enterUsernameWithReport(String username) {
		switchToMainFrame();
		if(enterById("UserName_Id", username))
			Reporter_ServiceNow.reportStep("The user name field is entered with text: "+username, "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The user name field could not entered with text: "+username, "FAILED");
		return this;
	}
	...
	// The login page allows the user to type their password into the password
	// field
	public LoginPage enterPasswordenterUsernameWithReport(String password) {
		switchToMainFrame();
		if(enterById("Password_Id", password))
			Reporter_ServiceNow.reportStep("The password field is entered with text: "+password, "SUCCESS");
		else
			Reporter_ServiceNow.reportStep("The password field could not entered with text: "+password, "FAILED");
