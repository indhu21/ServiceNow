...
public class ColorUtils {
    ...
    private ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Green", 0xDC, 0xDC, 0xDC));
    ...
    public String getColorName(String colorInRgb){
    
    	String[] colors = colorInRgb.replace("rgba(", "").replace(")", "").split(",");
		return getColorNameFromRgb(Integer.parseInt(colors[0].trim()),Integer.parseInt(colors[1].trim()), Integer.parseInt(colors[2].trim()));
    }
}