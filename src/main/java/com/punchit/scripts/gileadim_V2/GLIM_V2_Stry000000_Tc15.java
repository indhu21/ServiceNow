...
public class GLIM_V2_Stry000000_Tc15 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_V2_Stry000000_Tc15",groups="IncidentManagement")
...
//			.createIncidentWithWorkInProcessAndOpenIncident(configItem, repCust, asgGroup, addCIdesc, incNumber, asgTo)
	...
	@DataProvider(name = "GLIM_V2_Stry000000_Tc15")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_Tc15");
		return arrayObject;
	}
}
