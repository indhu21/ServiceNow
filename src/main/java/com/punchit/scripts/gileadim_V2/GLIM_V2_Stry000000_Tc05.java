...
public class GLIM_V2_Stry000000_Tc05 extends SuiteMethods {

	// Create Instance
	@Test(dataProvider = "GLIM_V2_Stry000000_Tc05",groups="IncidentManagement")
	public void IncCIFieldActiveAndInactive(String regUser, String regPwd,
...
//			System.out.println(incNumber1);
	...
	@DataProvider(name = "GLIM_V2_Stry000000_Tc05")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_Tc05");
		return arrayObject;
	}
}
