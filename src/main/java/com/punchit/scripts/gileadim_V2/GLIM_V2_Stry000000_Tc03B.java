...
public class GLIM_V2_Stry000000_Tc03B extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_V2_Stry000000_Tc03B",groups="IncidentManagement")
...
//			.verifyExtensionNumberField().verifyExtensionNumberFieldReadOnly();
	...
	@DataProvider(name = "GLIM_V2_Stry000000_Tc03B")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_Tc03B");
		return arrayObject;
	}
}
