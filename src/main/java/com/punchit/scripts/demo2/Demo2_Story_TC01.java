...
public class Demo2_Story_TC01 extends  SuiteMethods_demo1  {
	...
	public void createIncident (String regUser, String regPwd, String affuser, String cat,
			...
			String shrtdes, String assignto) {
		...
		try {
				...
				String incNumber =
						...
						incident.createIncidentForDemo(affuser, cat, subcat, ci, impact, urgency, asngrp)
