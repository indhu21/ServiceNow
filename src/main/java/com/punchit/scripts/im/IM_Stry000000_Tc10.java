...
public class IM_Stry000000_Tc10 extends SuiteMethods {
	
	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc10",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd,
		...
		try {
			...
			incident.enterConfigurationItemForSuccess(configItem1).Wait(2000);;
...
//			incident.verifyBusinessServiceEditable().verifyBusinessServiceContent(businessService1);
	...
	@DataProvider(name = "IM_Stry000000_Tc10")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc10");
		return arrayObject;
	}
}
