...
public class IM_Stry000000_Tc25B extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc25B",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd,String configItem, String repCust, 
		...
		try {
			...
			.uploadFile("IM_Stry000000_Tc25B")
			.clickActivityLog()
	...
	@DataProvider(name = "IM_Stry000000_Tc25B")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc25B");
		return arrayObject;
	}
}
