...
public class IM_Stry000000_Tc05B extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc05B",groups="IncidentManagement")
	...
	@DataProvider(name = "IM_Stry000000_Tc05B")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc05B");
		return arrayObject;
	}
}
