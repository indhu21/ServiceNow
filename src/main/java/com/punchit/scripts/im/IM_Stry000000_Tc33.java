...
public class IM_Stry000000_Tc33 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc33",groups="IncidentManagement")
	...
	@DataProvider(name = "IM_Stry000000_Tc33")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc33");
		return arrayObject;
	}
}
