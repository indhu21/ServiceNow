...
public class IM_Stry000000_Tc59 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc59",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd){
		...
		try {
			...
			String[] filter={"Assignment Group = SPARC L1", "Assigned To is empty"};
			String groupName="SPARC L1";
	...
	@DataProvider(name = "IM_Stry000000_Tc59")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc59");
		return arrayObject;
	}
}
