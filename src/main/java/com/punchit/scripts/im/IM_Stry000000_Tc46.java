...
public class IM_Stry000000_Tc46 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "IM_Stry000000_Tc46",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd,
			String configItem, String repCust, 
			String asgGroup, String desc,
			String aUser, String causingCI,
		...
		try {
			...
			home.expandReportsMenu().clickViewRun();
	...
	@DataProvider(name = "IM_Stry000000_Tc46")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc46");
		return arrayObject;
	}
}
