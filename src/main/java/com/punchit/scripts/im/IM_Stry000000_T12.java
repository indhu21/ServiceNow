...
public class IM_Stry000000_T12  extends SuiteMethods{
	// Create Instance

	@Test(dataProvider = "IM_Stry000000_T12",groups="IncidentManagement")
	...
	@DataProvider(name = "IM_Stry000000_T12")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_T12");
		return arrayObject;
	}
}
