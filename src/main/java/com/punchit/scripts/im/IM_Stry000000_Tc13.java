...
public class IM_Stry000000_Tc13 extends SuiteMethods {
	// Create Instance

		@Test(dataProvider = "IM_Stry000000_Tc13",groups="IncidentManagement")
		public void createIncident(String regUser, String regPwd,String filtervalue){
			...
			try {
				...
				incident.clickCIComponentLookUp().verifyCIComponentDatabaseLookUpValues();
		...
		@DataProvider(name = "IM_Stry000000_Tc13")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("IM_Stry000000_Tc13");
			return arrayObject;
		}
	}
