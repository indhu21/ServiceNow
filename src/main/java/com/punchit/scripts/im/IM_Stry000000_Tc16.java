...
public class IM_Stry000000_Tc16 extends SuiteMethods {
	
	// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider = "IM_STRYT16_TC01",groups="IncidentManagement")
		public void createIncident(String regUser, String regPwd,
			...
			try {
				...
				incident.verifyCIComponentLookUpValues_Power();
		...
		@DataProvider(name = "IM_STRYT16_TC01")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("IM_STRYT16_TC01");
			return arrayObject;
		}
	}
