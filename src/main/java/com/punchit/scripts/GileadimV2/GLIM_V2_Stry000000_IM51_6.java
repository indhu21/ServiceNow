...
public class GLIM_V2_Stry000000_IM51_6 extends SuiteMethods {


	@Test(dataProvider = "GLIM_V2_Stry000000_IM51_6",groups="IncidentManagement")
		...
		try {
			...
			incident.enterConfigurationItemForSuccess(configItem)
				...
				home.clickAll()	
					...
					.clickReopen("test")
					.returMenuPage()
					.addNumberofDays(incNumber, slA3[0], regUser1, regPwd1, 3)
	...
	@DataProvider(name = "GLIM_V2_Stry000000_IM51_6")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_IM51_6");
		return arrayObject;
	}
