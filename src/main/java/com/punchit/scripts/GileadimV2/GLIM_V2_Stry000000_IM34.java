...
public class GLIM_V2_Stry000000_IM34 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_V2_Stry000000_IM34",groups="IncidentManagement")
...
//					.isVipFlagExistsNextToIncidentNumber();
	...
	@DataProvider(name = "GLIM_V2_Stry000000_IM34")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_IM34");
		return arrayObject;
	}
}
