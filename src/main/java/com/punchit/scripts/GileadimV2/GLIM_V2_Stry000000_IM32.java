...
public class GLIM_V2_Stry000000_IM32 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_V2_Stry000000_IM32",groups="IncidentManagement")
	public void createIncident(	String regUser, String regPwd,String people,
								String abletowork,String desc,String CIA,String CIB,
...
//			.clickFirstIncident()
	...
	@DataProvider(name = "GLIM_V2_Stry000000_IM32")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_IM32");
		return arrayObject;
	}
}
