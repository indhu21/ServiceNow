...
public class GLIM_V2_Stry000000_IM51_7 extends SuiteMethods {


	@Test(dataProvider = "GLIM_V2_Stry000000_IM51_7",groups="IncidentManagement")
		...
		try {
			...
			incident.enterConfigurationItemForSuccess(configItem)
				...
				home.clickAll()	
					...
					.clickReopen("test")
					.returMenuPage()
					.addNumberofDays(incNumber, slA3[0], regUser1, regPwd1, 7)
	...
	@DataProvider(name = "GLIM_V2_Stry000000_IM51_7")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_IM51_7");
		return arrayObject;
	}
