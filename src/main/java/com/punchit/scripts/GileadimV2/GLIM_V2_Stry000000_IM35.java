...
public class GLIM_V2_Stry000000_IM35 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_V2_Stry000000_IM35",groups="IncidentManagement")
...
//					.clickSaveButton()
	...
	@DataProvider(name = "GLIM_V2_Stry000000_IM35")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_V2_Stry000000_IM35");
		return arrayObject;
	}
