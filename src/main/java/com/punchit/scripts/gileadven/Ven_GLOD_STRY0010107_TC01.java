...
public class Ven_GLOD_STRY0010107_TC01 extends SuiteMethods {
	// Create Instance
	ServiceNowWrappers snW;
	
	@Test(dataProvider = "Ven_GLOD_STRY0010107_TC01",groups="OpsDirector")
	public void appProperties(String regUser, String regPwd, String Attribute, String threshold, String val1, String val2, String val3, String val4) throws COSVisitorException, IOException, InterruptedException {
		...
		@DataProvider(name = "Ven_GLOD_STRY0010107_TC01")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010107_TC01");
			return arrayObject;
		}
}
