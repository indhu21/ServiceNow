...
public class Ven_GLOD_STRY0011172_TC01 extends SuiteMethods {
	// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "Ven_GLOD_STRY0011172_TC01",groups="OpsDirector")
	            ...
	            */  
				   // Choose Owning Group as Punch Group from the list that
					...
					//Step 7: Select Business services as Global retail bank
						if(snW.enterAndChoose("CI_BusinessService_Xpath", CI_Service))
						Reporter.reportStep("Step 7: The CI Business Services has been selected successfully ","SUCCESS");
					else
...
/*
	...
	*/				
				...
				@DataProvider(name = "Ven_GLOD_STRY0011172_TC01")
				public Object[][] fetchData() throws IOException {
					Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0011172_TC01");
					return arrayObject;
				}
	}
