...
public class Ven_GLOD_STRY0011426_TC02  extends SuiteMethods{
	
					ServiceNowWrappers snW;

					@Test(dataProvider = "Ven_GLOD_STRY0011426_TC02",groups="OpsDirector")
					public void createCIScope(String regUser, String regPwd, String name,
						...
						try {
							...
							if(snW.verifyallElementText("CIS_TargetCIs_Xpath", "ESX Server"))
								Reporter.reportStep("Step 7: All Elements are listed matched with ESX Server successful","SUCCESS");
							else
								Reporter.reportStep("Step 7: All Elements are listed could not matched with ESX Server","FAILURE");
							...
							if(snW.verifyallElementText("CIS_TargetCIs_Xpath", "ESX Server"))
								Reporter.reportStep("Step 10: All Elements are listed matched with ESX Server","SUCCESS");
							else
					...
					@DataProvider(name = "Ven_GLOD_STRY0011426_TC02")
					public Object[][] fetchData() throws IOException {
						Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0011426_TC02");
						return arrayObject;
					}
				}
