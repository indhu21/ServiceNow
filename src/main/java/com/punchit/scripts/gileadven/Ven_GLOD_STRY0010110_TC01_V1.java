...
public class Ven_GLOD_STRY0010110_TC01_V1 extends SuiteMethods {
	
		// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider = "Ven_GLOD_STRY0010110_TC01_V1",groups="OpsDirector")
		public void profval(String regUser, String regPwd) throws COSVisitorException, IOException {
			...
			try {
				...
				//	snW.enterById("Own_Grp", "Punch Group1");
					...
					snW.selectByVisibleTextById("Alert_Reaction", "Create Incident Automatically");
					...
					snW.selectByVisibleTextById("Reac_Type", "Create Incident Automatically");
		...
		@DataProvider(name = "Ven_GLOD_STRY0010110_TC01_V1")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010110_TC01_V1");
			return arrayObject;
		}
