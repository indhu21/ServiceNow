...
public class Ven_GLOD_Stry0010938_Tc01 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "Ven_GLOD_Stry0010938_Tc01")
...
//			
	...
	@DataProvider(name = "Ven_GLOD_Stry0010938_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider
				.getSheet("Ven_GLOD_Stry0010938_Tc01");
		return arrayObject;
	}
