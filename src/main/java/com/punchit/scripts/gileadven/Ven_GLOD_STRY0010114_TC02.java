...
public class Ven_GLOD_STRY0010114_TC02 extends SuiteMethods{

	
	// Create Instance
	ServiceNowWrappers snW;
	
	@Test(dataProvider = "Ven_GLOD_STRY0010114_TC02",groups="OpsDirector")
		          ...
		          //  snW.selectMenu(menuHeader, menuSubHeader, menu)
					...
					//Check the Alert Console table for the given condition for the alers to exist.
				     //Add Filter to Get Runbook with Steps available.
					      ...
					      snW.pressKey(Keys.TAB);
					      snW.pressKey(Keys.TAB);
					      snW.selectByVisibleTextByXpath("Data_Alert_FilterValue2_Xpath", "Work in Progress");
					      Thread.sleep(3000);
					...
					@DataProvider(name = "Ven_GLOD_STRY0010114_TC02")
					public Object[][] fetchData() throws IOException {
						Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010114_TC02");
						return arrayObject;
					}
		}
