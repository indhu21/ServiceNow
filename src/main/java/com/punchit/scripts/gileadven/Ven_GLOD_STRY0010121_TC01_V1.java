...
public class Ven_GLOD_STRY0010121_TC01_V1 extends SuiteMethods {
	// Create Instance
				ServiceNowWrappers snW;

				@Test(dataProvider = "Ven_GLOD_STRY0010121_TC01_V1",groups="OpsDirector")
				public void createCIScope(String regUser, String regPwd, String name,
					...
					try {
						...
						//if (snW.clickById("CIS_UpdateButton_Id")) {
							//snW.Wait(5000);
							//Reporter.reportStep("Step 9: The Update is clicked  successfully","SUCCESS");
						//} else
...
*/
				...
				@DataProvider(name = "Ven_GLOD_STRY0010121_TC01_V1")
				public Object[][] fetchData() throws IOException {
					Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010121_TC01_V1");
					return arrayObject;
				}
			}
