...
public class Ven_GLOD_STRY0011432_TC02_V1 extends SuiteMethods {
	
			// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "Ven_GLOD_STRY0011432_TC02_V1",groups="OpsDirector")
			public void profreg(String regUser, String regPwd,
				...
				try {
					...
					if(snW.enterAndChoose("Alert_Profile_IncidentAssignmentGroup_Xpath_new_sparc", "**"))
						Reporter.reportStep("Step 9a: Incident Assignment Group selected", "SUCCESS");
					else
						Reporter.reportStep("Step 9a: Incident Assignment Group not selected", "FAILURE");

					if(snW.enterAndChoose("Alert_Profile_OwningGroup_Xpath_new_sparc", "**"))
						Reporter.reportStep("Step 9b: Owning Group selected", "SUCCESS");
					else
						Reporter.reportStep("Step 9b: Owning Group could not be selected", "FAILURE");
			...
			@DataProvider(name = "Ven_GLOD_STRY0011432_TC02_V1")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0011432_TC02_V1");
				return arrayObject;
			}
}