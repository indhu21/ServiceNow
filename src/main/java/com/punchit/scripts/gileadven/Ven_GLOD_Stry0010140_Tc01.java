...
public class Ven_GLOD_Stry0010140_Tc01 extends SuiteMethods{
	// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider="Ven_GLOD_Stry0010140_Tc01",groups="OpsDirector")
		public void implementSLA(String regUser, String regPwd,String name, String desc, String owningGroup, String value1,String value2, String sec) {
			try {
				...
				if(snW.doubleCickByXpath("ALERTPROFILE_Registartion_CIscopes_xpath"))
					Reporter.reportStep("Step 3a:  CI Scope is selected successfully", "SUCCESS");
				else
					Reporter.reportStep("Step 3b: CI scope could not be selected", "FAILURE");
		...
		@DataProvider(name="Ven_GLOD_Stry0010140_Tc01")
		public Object[][] loginData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_Stry0010140_Tc01");
			return arrayObject;
		}
	}
