...
public class Ven_GLOD_STRY0010135_TC01_V3 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "Ven_GLOD_STRY0010135_TC01_V3",groups="OpsDirector")
	...
	@DataProvider(name = "Ven_GLOD_STRY0010135_TC01_V3")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010135_TC01_V3");
		return arrayObject;
	}
}