...
public class Ven_GLOD_STRY0010708_TC01 extends SuiteMethods {
	// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider = "Ven_GLOD_STRY0010708_TC01",groups="OpsDirector")
		public void createCIScope(String regUser, String regPwd) throws COSVisitorException,
			...
			try {
				...
				//Step 3: Click on My Alerts
				 //if(snW.clickByXpath("MY_ALERT_Xpath"))
					 ...
					 Reporter.reportStep("Step 3: New alert  Link clicked successfully","SUCCESS");
					else
						Reporter.reportStep("Step 3: New alert  Link could not be clicked ","FAILURE");
				//Step 4: Click on Funnel icon
				 if(snW.clickById("ALERT_FunnelIcon_Id"))
					 Reporter.reportStep("Step 4: New Alert - Funnel clicked successfully","SUCCESS");
					else
				...
				//Step 5: To check the State is Flapping or state is new 
				 ...
				 String filter_values = snW.getTextByXpath("FUNNEL_FILTER_Xpath");
					...
					for (int i=0; i<arrSplit.length;i++)
					{
						...
						{
						Reporter.reportStep("Step 5:State is Flapping or state is New hence passed","SUCCESS");
						break;
						}
			...
			@DataProvider(name = "Ven_GLOD_STRY0010708_TC01")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010708_TC01");
				return arrayObject;
			}
			}
