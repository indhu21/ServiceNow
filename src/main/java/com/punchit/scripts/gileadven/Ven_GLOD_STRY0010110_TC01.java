...
public class Ven_GLOD_STRY0010110_TC01 extends SuiteMethods {
	
		// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider = "Ven_GLOD_STRY0010110_TC01",groups="OpsDirector")
		...
		@DataProvider(name = "Ven_GLOD_STRY0010110_TC01")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010110_TC01");
			return arrayObject;
		}
