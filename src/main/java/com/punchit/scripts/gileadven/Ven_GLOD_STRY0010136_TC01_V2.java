...
public class Ven_GLOD_STRY0010136_TC01_V2 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "Ven_GLOD_STRY0010136_TC01_V2",groups="OpsDirector")
	public void alertSuppressor (String regUser, String regPwd, String scheduleType,
			String shortDesc, String tablename, String document,String StartTime, String StopTime) throws COSVisitorException, IOException, ParseException {
		...
		try {
			...
			String supressName = "Punch Repeat dialy-"+formattedDate;
		   ...
		   // if(snW.clickById("Submit_Id"))
			...
			@DataProvider(name = "Ven_GLOD_STRY0010136_TC01_V2")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010136_TC01_V2");
				return arrayObject;
			}
		}
