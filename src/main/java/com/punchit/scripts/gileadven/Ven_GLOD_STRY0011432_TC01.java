...
public class Ven_GLOD_STRY0011432_TC01 extends SuiteMethods {
	
			// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "Ven_GLOD_STRY0011432_TC01",groups="OpsDirector")
			public void profreg(String regUser, String regPwd, String verUser, String verPwd,
				...
				try {
					...
					//Reporter.reportStep("Step 10: Values entered in the fields as per reference data","SUCCESS");
			...
			@DataProvider(name = "Ven_GLOD_STRY0011432_TC01")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0011432_TC01");
				return arrayObject;
			}
}