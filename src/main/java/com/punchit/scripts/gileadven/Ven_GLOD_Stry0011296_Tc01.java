...
public class Ven_GLOD_Stry0011296_Tc01 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "Ven_GLOD_Stry0011296_Tc01",groups="OpsDirector")
	...
	@DataProvider(name = "Ven_GLOD_Stry0011296_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider
				.getSheet("Ven_GLOD_Stry0011296_Tc01");
		return arrayObject;
	}
