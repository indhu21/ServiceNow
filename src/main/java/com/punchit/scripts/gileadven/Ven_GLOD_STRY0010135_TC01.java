...
public class Ven_GLOD_STRY0010135_TC01 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "Ven_GLOD_STRY0010135_TC01",groups="OpsDirector")
	public void alertSuppressor (String regUser, String regPwd, String scheduleType, String shortDesc, 
			 ...
			 String tablename, String document) 
		...
		try {
			...
			if(!snW.clickById("ALERT_Suppress_Supressdays_Id"))
				Reporter.reportStep("Step 3: Alert Suppress days could not be entered","FAILURE");
		...
		@DataProvider(name = "Ven_GLOD_STRY0010135_TC01")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("Ven_GLOD_STRY0010135_TC01");
			return arrayObject;
		}
}