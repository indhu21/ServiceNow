...
public class OOBIncident_Stry000000_TC04 extends SuiteMethods_ServiceNowFrontEnd{
	
	@Test(dataProvider = "OOBIncident_Stry000000_TC04", groups="OutOfBox")
...
//					.clickLogout();
	...
	@DataProvider(name = "OOBIncident_Stry000000_TC04")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OOBIncident_Stry000000_TC04");
		return arrayObject;
	}
}
