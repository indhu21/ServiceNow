...
public class OOBIncident_Stry000000_TC06 extends SuiteMethods_ServiceNowFrontEnd{
	
	@Test(dataProvider = "OOBIncident_Stry000000_TC06", groups="OutOfBox")
...
//						.clickLogout();
	...
	@DataProvider(name = "OOBIncident_Stry000000_TC06")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OOBIncident_Stry000000_TC06");
		return arrayObject;
	}
}
