...
public class OOBIncident_Stry000000_TC02 extends SuiteMethods_ServiceNowFrontEnd{
	
	@Test(dataProvider = "OOBIncident_Stry000000_TC02", groups="OutOfBox")
...
//					.clickLogout();
	...
	@DataProvider(name = "OOBIncident_Stry000000_TC02")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OOBIncident_Stry000000_TC02");
		return arrayObject;
	}
}
