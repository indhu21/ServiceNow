...
public class OOBIncident_Stry000000_TC03 extends SuiteMethods_ServiceNowFrontEnd{
	
	@Test(dataProvider = "OOBIncident_Stry000000_TC03", groups="OutOfBox")
...
//					.clickLogout();
	...
	@DataProvider(name = "OOBIncident_Stry000000_TC03")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OOBIncident_Stry000000_TC03");
		return arrayObject;
	}
}
