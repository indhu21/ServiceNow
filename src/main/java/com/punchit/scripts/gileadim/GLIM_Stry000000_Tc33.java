...
public class GLIM_Stry000000_Tc33 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc33",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd,String causingCI ,String CI,String Reportingcustomer,String Group,
			String Description, String Assignto) {
...
//						.verifyCIComponentApplicationLookUpValues();
						.verifyCIComponentApplicationLookUpValuesCIcounts();
...
//			.verifyCIComponentApplicationLookUpValues();
	...
	@DataProvider(name = "GLIM_Stry000000_Tc33")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc33");
		return arrayObject;
	}
}
