...
public class GLIM_Stry000000_Tc53 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc53",groups="IncidentManagement")
...
//					snW.quitBrowser();			
	...
	@DataProvider(name = "GLIM_Stry000000_Tc53")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc53");
		return arrayObject;
	}
}
