...
public class GLIM_Stry000000_Tc15 extends SuiteMethods {
	

		@Test(dataProvider = "GLIM_Stry000000_Tc15",groups="IncidentManagement")
...
//						.clickCIComponetSpyGlassAndverifyCIComponetSpyGlass(elements);
		...
		@DataProvider(name = "GLIM_Stry000000_Tc15")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc15");
			return arrayObject;
		}
	}
