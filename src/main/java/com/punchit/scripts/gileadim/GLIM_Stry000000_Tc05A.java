...
public class GLIM_Stry000000_Tc05A extends SuiteMethods {

	// Create Instance
	@Test(dataProvider = "GLIM_Stry000000_Tc05A",groups="IncidentManagement")
	...
	@DataProvider(name = "GLIM_Stry000000_Tc05A")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc05A");
		return arrayObject;
	}
}
