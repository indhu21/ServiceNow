...
public class GLIM_Stry000000_Tc20 extends SuiteMethods {
	
	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc20",groups="IncidentManagement")
...
//			incident.hoverGroupId();
	...
	@DataProvider(name = "GLIM_Stry000000_Tc20")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc20");
		return arrayObject;
	}
}
