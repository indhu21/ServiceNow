...
public class GLIM_Stry000000_Tc09 extends SuiteMethods {

	// Create Instance
	@Test(dataProvider = "GLIM_Stry000000_Tc09",groups="IncidentManagement")
...
//			incident.verifyBusinessServiceReadOnly()
	...
	@DataProvider(name = "GLIM_Stry000000_Tc09")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc09");
		return arrayObject;
	}
}
