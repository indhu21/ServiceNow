...
public class GLIM_Stry000000_Tc27 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc27",groups="IncidentManagement")
...
//					.alertAcceptforResolve()
	...
	@DataProvider(name = "GLIM_Stry000000_Tc27")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc27");
		return arrayObject;
	}
}
