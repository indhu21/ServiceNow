...
public class GLIM_Stry000000_Tc73 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc73",groups="IncidentManagement")
	public void createIncident(String regUser, String regPwd,
		...
		String [] ele = {"Account unlocked",	
				...
				"DHCP reset",	
		"DNS restored"};
		String[] ele1={"Documentation updated",
				"Emergency Fix",
...
//			.verifyResolutionCodeSpyGlass(ele1, true);
	...
	@DataProvider(name = "GLIM_Stry000000_Tc73")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc73");
		return arrayObject;
	}
}
