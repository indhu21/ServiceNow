...
public class GLIM_Stry000000_Tc57 extends SuiteMethods {

	// Create Instance
	@Test(dataProvider = "GLIM_Stry000000_Tc57",groups="IncidentManagement")
...
//				.ClickAssignToMe()
			...
			home.clickWIPWithoutReport().verifyFilterTextAterReset(filter);
			status = "PASS";
	...
	@DataProvider(name = "GLIM_Stry000000_Tc57")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc57");
		return arrayObject;
	}
}
