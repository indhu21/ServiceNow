...
public class GLIM_Stry000000_Tc04B extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc04B",groups="IncidentManagement")
...
//					
	...
	@DataProvider(name = "GLIM_Stry000000_Tc04B")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc04B");
		return arrayObject;
	}
}
