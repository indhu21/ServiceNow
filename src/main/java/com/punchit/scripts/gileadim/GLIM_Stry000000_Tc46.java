...
public class GLIM_Stry000000_Tc46 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc46",groups="IncidentManagement")
...
//						    .verifyValueAndMoveToSelected(elements)
	...
	@DataProvider(name = "GLIM_Stry000000_Tc46")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc46");
		return arrayObject;
	}
}
