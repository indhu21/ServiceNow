...
public class GLIM_Stry000000_Tc04 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc04",groups="IncidentManagement")
...
//			incident.submitWithoutReport().searchandClickIncident(incNumber).verifyReportingCustomerAffectedUser();
	...
	@DataProvider(name = "GLIM_Stry000000_Tc04")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc04");
		return arrayObject;
	}
}
