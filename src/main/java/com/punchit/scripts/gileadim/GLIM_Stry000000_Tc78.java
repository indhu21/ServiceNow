...
public class GLIM_Stry000000_Tc78 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc78",groups="IncidentManagement")
...
//			.clickResolutioCodeSpyGlass()
	...
	@DataProvider(name = "GLIM_Stry000000_Tc78")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc78");
		return arrayObject;
	}
}
