...
public class GLRB_STRY0011052_TC01 extends SuiteMethods {
	...
	public void appProperties(String regUser, String regPwd) throws COSVisitorException, IOException, InterruptedException {
		...
		try {
			...
			if (snW.selectMenuFromMainHeader("RunBook", "My_Template"))
				Reporter.reportStep("Step 2: The My Template  - menu is displayed ","SUCCESS");
			else
				Reporter.reportStep("Step 2: The My Template  - menu is not  displayed ","FAILURE");
			...
			if (snW.selectMenuFromMainHeader("RunBook", "My_Schedules"))
				Reporter.reportStep("Step 3: The My Schedule  - menu is displayed ","SUCCESS");
			else
				Reporter.reportStep("Step 3: The My Schedule  - menu is not  displayed ","FAILURE");
			
			// step 5 :check if Templates link is available
			if (snW.selectMenu("RunBook","RunBook_Definition", "Templates"))
				Reporter.reportStep("Step 4: The Templates  - menu is displayed ","SUCCESS");
			else
				Reporter.reportStep("Step 4: The Templates  - menu is not  displayed ","FAILURE");	
			//
