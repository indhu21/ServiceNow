...
public class OOBChange_Stry000000_TC08 extends SuiteMethods_ServiceNowFrontEnd{

	@Test(dataProvider = "OOBChange_Stry000000_TC08", groups="OutOfBox")
	public void createIncident(String regUser, String regPwd, String filter, 
			...
			String priority, String risk, String impact,String message){
...
//		snW.launchApp_ServiceNow(browserName, true,entityId);
	...
	@DataProvider(name = "OOBChange_Stry000000_TC08")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OOBChange_Stry000000_TC08");
		return arrayObject;
	}
}
