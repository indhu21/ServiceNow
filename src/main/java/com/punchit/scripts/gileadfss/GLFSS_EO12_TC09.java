...
public class GLFSS_EO12_TC09 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO12_TC09",groups="GLFSS")
...
try {
	...
	@DataProvider(name = "GLFSS_EO12_TC09")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO12_TC09");
		return arrayObject;
	}
}