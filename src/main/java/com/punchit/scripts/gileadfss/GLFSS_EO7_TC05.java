...
public class GLFSS_EO7_TC05 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO7_TC05",groups="GLFSS")
...
try {
	...
	@DataProvider(name = "GLFSS_EO7_TC05")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO7_TC05");
		return arrayObject;
	}
}