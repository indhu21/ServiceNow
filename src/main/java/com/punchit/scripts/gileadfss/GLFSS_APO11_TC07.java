...
public class GLFSS_APO11_TC07 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_APO11_TC07",groups="GLFSS")
...
snW.switchToDefault();
	...
	@DataProvider(name = "GLFSS_APO11_TC07")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_APO11_TC07");
		return arrayObject;
	}
}