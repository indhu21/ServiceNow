...
public class GLFSS_APO12_TC08 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_APO12_TC08",groups="GLFSS")
...
try {
	...
	@DataProvider(name = "GLFSS_APO12_TC08")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_APO12_TC08");
		return arrayObject;
	}
}