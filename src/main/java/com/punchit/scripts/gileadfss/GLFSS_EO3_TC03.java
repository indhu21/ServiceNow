...
public class GLFSS_EO3_TC03 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO3_TC03",groups="GLFSS")
...
try {
	...
	@DataProvider(name = "GLFSS_EO3_TC03")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO3_TC03");
		return arrayObject;
	}
}