...
public class GLFSS_EO14_TC011 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO14_TC011",groups="GLFSS")
...
try {
	...
	@DataProvider(name = "GLFSS_EO14_TC011")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO14_TC011");
		return arrayObject;
	}
}
