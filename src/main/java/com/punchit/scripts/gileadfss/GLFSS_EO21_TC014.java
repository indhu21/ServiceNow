...
public class GLFSS_EO21_TC014 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO21_TC014",groups="GLFSS")
...
try {
	...
	if(searchedNumber.equalsIgnoreCase(enteredNumber))
		Reporter.reportStep("Step 4: The ticket created by FSS_EO1_TC01 is listed in My Items", "FAILURE");
	else
		Reporter.reportStep("Step 4: The ticket created by FSS_EO1_TC01 is not listed in My Items", "SUCCESS");
	...
	@DataProvider(name = "GLFSS_EO21_TC014")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO21_TC014");
		return arrayObject;
	}
}