...
public class GLFSS_APO14_TC10 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_APO14_TC10",groups="GLFSS")
...
try {
	...
	if(snW.getTextByXpath("FSS_FSSTasks_EntireForm_Xpath").contains("Open"))
		...
		if(snW.selectByVisibleTextByXpath("FSS_MyGroupsWork_State_Xpath", WIP))
			Reporter.reportStep("Step 6: State field is set successfully", "SUCCESS");
		else
			Reporter.reportStep("Step 6: State field could not be set successfully", "FAILURE");
...
//	snW.getDriver().get("https://sparctest.service-now.com/sparc/logout.do");
	...
	@DataProvider(name = "GLFSS_APO14_TC10")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_APO14_TC10");
		return arrayObject;
	}
}