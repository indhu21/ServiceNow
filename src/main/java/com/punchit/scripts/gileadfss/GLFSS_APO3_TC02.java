...
public class GLFSS_APO3_TC02 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_APO3_TC02",groups="GLFSS")
...
try {
	...
	if(searchedNumber.equalsIgnoreCase(enteredNumber))
		Reporter.reportStep("Step 4: The ticket created by FSS_APO2_TC01 is listed in My Items", "SUCCESS");
	else
		Reporter.reportStep("Step 4: The ticket created by FSS_APO2_TC01 is not listed in My Items", "FAILURE");
	...
	@DataProvider(name = "GLFSS_APO3_TC02")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_APO3_TC02");
		return arrayObject;
	}
}