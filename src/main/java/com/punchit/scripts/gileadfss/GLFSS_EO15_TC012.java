...
public class GLFSS_EO15_TC012 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO15_TC012",groups="GLFSS")
	public void validateTicketMyGroupsWork(String regUser, String regPwd, String workNotes, String assignmentGroup) throws COSVisitorException,
...
try {
	// Step 0: Launch the application
		...
		if(snW.getTextByXpath("FSS_MyGroupsWork_AllRecords_Xpath").contains(ticketNumberEO1TC01))
	...
	@DataProvider(name = "GLFSS_EO15_TC012")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO15_TC012");
		return arrayObject;
	}
}
