...
public class GLFSS_EO17_TC013 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO17_TC013",groups="GLFSS")
...
Thread.sleep(2000);
	...
	@DataProvider(name = "GLFSS_EO17_TC013")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO17_TC013");
		return arrayObject;
	}
}