...
public class GLFSS_EO9_TC06 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_EO9_TC06",groups="GLFSS")
...
try {
	...
	snW.switchToFrame("Frame_Main");
		...
		if(searchedNumber.equalsIgnoreCase(enteredNumber))
			Reporter.reportStep("Step 4: The ticket number created by FSS_EO1_TC01 is listed in My Items", "SUCCESS");
		else
			Reporter.reportStep("Step 4: The ticket number created by FSS_EO1_TC01 is not listed in My Items", "FAILURE");
		...
		@DataProvider(name = "GLFSS_EO9_TC06")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_EO9_TC06");
			return arrayObject;
		}
	}
