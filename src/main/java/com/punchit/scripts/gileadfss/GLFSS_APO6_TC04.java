...
public class GLFSS_APO6_TC04 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLFSS_APO6_TC04",groups="GLFSS")
...
try {
	...
	if(snW.clickByXpath("FSS_FSSTasks_SearchedNumber_Xpath"))
		Reporter.reportStep("Step 4: Incident created in APO-1 clicked successfully", "SUCCESS");
	else
		Reporter.reportStep("Step 4: User not able to click the incident created in APO-1", "FAILURE");
	...
	@DataProvider(name = "GLFSS_APO6_TC04")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLFSS_APO6_TC04");
		return arrayObject;
	}
}
