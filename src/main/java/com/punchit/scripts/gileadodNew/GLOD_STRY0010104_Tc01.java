...
public class GLOD_STRY0010104_Tc01 extends SuiteMethods {

	@Test(dataProvider = "GLOD_STRY0010104_Tc01",groups="OpsDirector")
		...
		try {
			...
			String profilename = 
				...
				home.clickAlertProfiles()
					...
					.shouldNotUpdateButtonAvailable();
	...
	@DataProvider(name = "GLOD_STRY0010104_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010104_Tc01");
		return arrayObject;
	}
}
