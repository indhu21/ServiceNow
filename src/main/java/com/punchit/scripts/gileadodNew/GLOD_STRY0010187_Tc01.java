...
public class GLOD_STRY0010187_Tc01 extends SuiteMethods {
	
	@Test(dataProvider="GLOD_STRY0010187_Tc01",groups="OpsDirector")
	...
	@DataProvider(name="GLOD_STRY0010187_Tc01")
