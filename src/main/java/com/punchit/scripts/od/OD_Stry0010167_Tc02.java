...
public class OD_Stry0010167_Tc02 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_Stry0010167_Tc02")
	public void testName(String regUser, String regPwd, String scheduleType, String shortDesc, 
						 ...
						 String endHr, String endMn,String endSc) throws InterruptedException {
		...
		try {
			...
			if(snW.getTextByXpath("ALERT_AlertId_Xpath").equals("No records to display"))
			{
				...
				Reporter.reportStep("No Records are available under Alert Consoles","FAILURE");
...
//					Reporter.reportStep("Step 3: The 'Close Button' could not be clicked","FAILURE");
			...
			*/
			...
			System.out.println(sSuppProfile);
			...
			String supressName = (alertCI+" - "+formattedDate).substring(0, 35);
	...
	@DataProvider(name = "OD_Stry0010167_Tc02")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider
				.getSheet("OD_Stry0010167_Tc02");
		return arrayObject;
	}
