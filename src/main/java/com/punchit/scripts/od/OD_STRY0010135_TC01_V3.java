...
public class OD_STRY0010135_TC01_V3 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_STRY0010135_TC01_V3",groups="OpsDirector")
	...
	@DataProvider(name = "OD_STRY0010135_TC01_V3")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010135_TC01_V3");
		return arrayObject;
	}
}