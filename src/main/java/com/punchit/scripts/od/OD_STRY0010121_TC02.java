...
public class OD_STRY0010121_TC02 extends SuiteMethods {
	
	// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "OD_STRY0010121_TC02",groups="OpsDirector")
			public void createCIScope(String regUser, String regPwd, String name,
				...
				try {
					...
					if(Application1.equalsIgnoreCase("true"))
						Reporter.reportStep("Step 7: Application is mandatory ","SUCCESS");
					else
						Reporter.reportStep("Step 7: Application is not mandatory","WARNING");

			
					if(snW.enterByXpath("CI_Application_Xpath", Application))
						Reporter.reportStep("Step 7A: Application is Selected successfully with value " + Application  ,"SUCCESS");
					else
						Reporter.reportStep("Step 7A: Application could not be Selected successfully with value " + Application ,"FAILURE");
			...
			@DataProvider(name = "OD_STRY0010121_TC02")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010121_TC02");
				return arrayObject;
			}
		}
