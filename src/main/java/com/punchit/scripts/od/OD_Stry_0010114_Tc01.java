...
public class OD_Stry_0010114_Tc01 extends SuiteMethods{

	
	// Create Instance
	ServiceNowWrappers snW;
	
	@Test(dataProvider = "OD_STRY0010114_TC01",groups="OpsDirector")
		   ...
		   //Step 4: Click on the Magnification Symbol to display the alert tickets to make a parent ticket.
			...
			// FInd the Alert in My Alerts and click on the 
		     ...
		     // go out of the frame
				...
				@DataProvider(name = "OD_STRY0010114_TC01")
				public Object[][] fetchData() throws IOException {
					Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010114_TC01");
					return arrayObject;
				}
	}
