...
public class OD_STRY0010104_TC02_V1 extends SuiteMethods {
	
			// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "OD_STRY0010104_TC02_V1",groups="OpsDirector")
			...
			@DataProvider(name = "OD_STRY0010104_TC02_V1")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010104_TC02_V1");
				return arrayObject;
			}
}