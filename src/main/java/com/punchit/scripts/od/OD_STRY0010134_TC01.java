...
public class OD_STRY0010134_TC01 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_STRY0010134_TC01",groups="OpsDirector")
	...
	@DataProvider(name = "OD_STRY0010134_TC01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010134_TC01");
		return arrayObject;
	}
}