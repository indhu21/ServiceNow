...
public class OD_STRY0011427_TC01 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_STRY0011427_TC01")
...
/*						//Step 8:Verifying the reaction type as create incident
	...
	*/					
	     ...
	     @DataProvider(name = "OD_STRY0011427_TC01")
		    public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider
				.getSheet("OD_STRY0011427_TC01");
					return arrayObject;
	}
}
