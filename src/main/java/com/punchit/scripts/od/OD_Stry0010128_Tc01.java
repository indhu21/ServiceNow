...
public class OD_Stry0010128_Tc01 extends SuiteMethods{
	//private static final String EVENTS_CreatedLink_Xpath = null;
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_Stry0010128_Tc01",groups="OpsDirector")
...
//	
	...
	@DataProvider(name = "OD_Stry0010128_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_Stry0010128_Tc01");
		return arrayObject;
	}
}
