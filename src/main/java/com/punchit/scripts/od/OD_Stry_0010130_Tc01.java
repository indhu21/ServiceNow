...
public class OD_Stry_0010130_Tc01 extends SuiteMethods{

	// Create Instance
	ServiceNowWrappers snW;
	
	@Test(dataProvider = "OD_STRY0010130_TC01",groups="OpsDirector")
	...
	@DataProvider(name = "OD_STRY0010130_TC01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010130_TC01");
		return arrayObject;
	}
}
