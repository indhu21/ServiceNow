...
public class OD_Stry0010165_Tc01 extends SuiteMethods{
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_Stry0010165_Tc01",groups="OpsDirector")
...
try {
	...
	@DataProvider(name = "OD_Stry0010165_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_Stry0010165_Tc01");
		return arrayObject;
	}
}
