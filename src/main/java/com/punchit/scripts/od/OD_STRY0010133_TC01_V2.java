...
public class OD_STRY0010133_TC01_V2 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_STRY0010133_TC01_V2",groups="OpsDirector")
	...
	@DataProvider(name = "OD_STRY0010133_TC01_V2")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010133_TC01_V2");
		return arrayObject;
	}
}