...
public class OD_STRY0011171_TC01 extends SuiteMethods {
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_STRY0011171_TC01",groups="OpsDirector")
	public void Configure_Business_CI_Scope(String regUser, String regPwd,String name,
		...
		try {
			...
			if(snW.enterByXpathAndClick("CI_Application_Xpath", CI_Service))
				Reporter.reportStep("Step 7: The CI Application has been selected successfully with value "+CI_Service,"SUCCESS");
			else
			...
			String element= snW.getTextByXpath("Application_Target_CI_Xpath");
	...
	@DataProvider(name = "OD_STRY0011171_TC01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0011171_TC01");
		return arrayObject;
	}
}