...
public class OD_Stry0010165_Tc02 extends SuiteMethods{
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_Stry0010165_Tc02",groups="OpsDirector")
...
try {
	...
	@DataProvider(name = "OD_Stry0010165_Tc02")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("OD_Stry0010165_Tc02");
		return arrayObject;
	}
}
