...
public class OD_STRY0010104_TC02 extends SuiteMethods {
	
	// Create Instance
			ServiceNowWrappers snW;

			@Test(dataProvider = "OD_STRY0010104_TC02",groups="OpsDirector")
			public void profreg(String regUser, String regPwd, String verUser, String verPwd,
				...
				try {
					...
					snW.Wait(500);
					if (!snW.enterByXpathAndClick("Prof_Search_Xpath", profnum))
					...
					if (snW.IsElementPresentById("Update_Button"))
						Reporter.reportStep("Step 15: The Update button has been found as expected.", "SUCCESS");
					else
						Reporter.reportStep("Step 15: The Update button could not been found.","FAILURE");
					
					// Step 14B: Validate that there is no Delete button
					if (snW.IsElementPresentById("Delete_Button"))
						Reporter.reportStep("Step 15B: The Delete button has been found as expected.", "SUCCESS");
					else
						Reporter.reportStep("Step 15B: The Delete button could not been found.","FAILURE");
			...
			@DataProvider(name = "OD_STRY0010104_TC02")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("OD_STRY0010104_TC02");
				return arrayObject;
			}
}