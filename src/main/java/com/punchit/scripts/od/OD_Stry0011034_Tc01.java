...
public class OD_Stry0011034_Tc01 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "OD_Stry0011034_Tc01")
	...
	@DataProvider(name = "OD_Stry0011034_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider
				.getSheet("OD_Stry0011034_Tc01");
		return arrayObject;
	}
