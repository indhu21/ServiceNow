...
public class GLOD_STRY0010133_ALRT_PROF extends SuiteMethods {
	
	
	@Test(dataProvider = "GLOD_STRY0010133_TC01",groups="OpsDirector")
	...
	@DataProvider(name = "GLOD_STRY0010133_TC01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010133_TC01");
		return arrayObject;
	}
}