...
public class GLOD_STRY0010133_CI_Scope extends SuiteMethods {


	@Test(dataProvider = "GLOD_STRY0010133_TC01_V1",groups="OpsDirector")
	public void alertSuppressor (String regUser, String regPwd, String scheduleType, String shortDesc,
								 String supresstype, String tablename, String document, String syssch, String name) {
		...
		try {
			...
			MenuPage home = 
					...
					home.clickAlertSuppressors()
						...
						.rightClickAndSave()
						//.verifyAlertSuppTarget(document);
	...
	@DataProvider(name = "GLOD_STRY0010133_TC01_V1")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010133_TC01_V1");
		return arrayObject;
	}
}