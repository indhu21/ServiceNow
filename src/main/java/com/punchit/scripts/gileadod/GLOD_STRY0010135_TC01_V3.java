...
public class GLOD_STRY0010135_TC01_V3 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLOD_STRY0010135_TC01_V3",groups="OpsDirector")
	...
	@DataProvider(name = "GLOD_STRY0010135_TC01_V3")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010135_TC01_V3");
		return arrayObject;
	}
}