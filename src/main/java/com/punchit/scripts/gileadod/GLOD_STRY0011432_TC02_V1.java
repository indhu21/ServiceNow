...
public class GLOD_STRY0011432_TC02_V1 extends SuiteMethods {
	

			@Test(dataProvider = "GLOD_STRY0011432_TC02_V1",groups="OpsDirector")
			...
			@DataProvider(name = "GLOD_STRY0011432_TC02_V1")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0011432_TC02_V1");
				return arrayObject;
			}
}