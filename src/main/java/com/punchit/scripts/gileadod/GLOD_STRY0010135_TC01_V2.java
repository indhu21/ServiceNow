...
public class GLOD_STRY0010135_TC01_V2 extends SuiteMethods {
	
	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLOD_STRY0010135_TC01_V2",groups="OpsDirector")
	...
	@DataProvider(name = "GLOD_STRY0010135_TC01_V2")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010135_TC01_V2");
		return arrayObject;
	}
}