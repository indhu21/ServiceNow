...
public class GLOD_STRY0011427_TC01 extends SuiteMethods {

	// Create Instance
	ServiceNowWrappers snW;

	@Test(dataProvider = "GLOD_STRY0011427_TC01")
		...
		try {
			...
			// Step 3: Clicking on new alert 
						...
						if(!snW.clickById("ALERT_FunnelIcon_Id"))
							Reporter.reportStep("Step 3: Filter icon could not be clicked","FAILURE");
						 snW.Wait(2000);
						// snW.clickByXpath("ALERT_Actionsandselcet_Xpath");
						if(!snW.clickByXpath("Runbook_Asignedtome_Filter_AND_Xpath"))
							Reporter.reportStep("Step 3: AND button could not be clicked","FAILURE");
...
/*						//Step 8:Verifying the reaction type as create incident
	...
	*/					
	     ...
	     @DataProvider(name = "GLOD_STRY0011427_TC01")
		    public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider
				.getSheet("GLOD_STRY0011427_TC01");
					return arrayObject;
	}
}
