...
public class GLOD_STRY0011432_TC02 extends SuiteMethods {
	
			
			@Test(dataProvider = "GLOD_STRY0011432_TC02",groups="OpsDirector")
			...
			@DataProvider(name = "GLOD_STRY0011432_TC02")
			public Object[][] fetchData() throws IOException {
				Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0011432_TC02");
				return arrayObject;
			}
}