...
public class GLOD_STRY0010110_TC01_V2 extends SuiteMethods {
	
		// Create Instance
		ServiceNowWrappers snW;

		@Test(dataProvider = "GLOD_STRY0010110_TC01_V2",groups="OpsDirector")
...
//					snW.clickByXpath("Alert_Reaction_Xpath");
		...
		@DataProvider(name = "GLOD_STRY0010110_TC01_V2")
		public Object[][] fetchData() throws IOException {
			Object[][] arrayObject = DataInputProvider.getSheet("GLOD_STRY0010110_TC01_V2");
			return arrayObject;
		}
