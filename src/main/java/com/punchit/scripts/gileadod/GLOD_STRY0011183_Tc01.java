...
public class GLOD_STRY0011183_Tc01 extends SuiteMethods {

	@Test(dataProvider = "GLOD_Stry0011183_Tc01",groups="OpsDirector")
	...
	@DataProvider(name = "GLOD_Stry0011183_Tc01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider
				.getSheet("GLOD_Stry0011183_Tc01");
		return arrayObject;
	}
