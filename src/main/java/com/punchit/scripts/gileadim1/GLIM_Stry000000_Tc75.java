...
public class GLIM_Stry000000_Tc75 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "GLIM_Stry000000_Tc75",groups="IncidentManagement")
	...
	@DataProvider(name = "GLIM_Stry000000_Tc75")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("GLIM_Stry000000_Tc75");
		return arrayObject;
	}
}
