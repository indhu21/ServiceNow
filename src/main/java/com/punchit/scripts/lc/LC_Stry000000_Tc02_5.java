...
public class LC_Stry000000_Tc02_5 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc02_5",groups="IncidentManagement")
	public void createIncident(	String regUser, String regPwd,String systemManager, String sysManager, String operationalstatus1,
		...
		try {
			...
			ServerWindowsPage sW = 
					home.clickWinserver()
//						.addFilterforFourValues(filterType7, filterCondition7, filterValue7, filterType9, filterCondition9, filterValue9, filterType8, filterCondition8, filterValue8, filterType10, filterCondition10, filterValue10)
//						.clickFirstWindowServerNamelink()
	...
	@DataProvider(name = "LC_Stry000000_Tc02_5")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc02_5");
		return arrayObject;
	}
}
