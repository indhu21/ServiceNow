...
public class LC_GapScript_01 extends SuiteMethods {

	@Test(dataProvider = "LC_GapScript_01",groups="CMDB")
		...
		try {
			...
			MenuPage home = 
				...
				home.clickScheduleDefinitions()
					...
					.clickExecuteNow()
					.rightClickReload()
					.isAvailableCerrtificationTaskAndInstancesTab();
	...
	@DataProvider(name = "LC_GapScript_01")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_GapScript_01");
		return arrayObject;
	}
}
