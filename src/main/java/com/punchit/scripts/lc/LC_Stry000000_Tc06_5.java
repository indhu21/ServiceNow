...
public class LC_Stry000000_Tc06_5 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc06_5",groups="IncidentManagement")
...
//						.clickFirstlinkofUPS(name)
			...
			String CMDBNum = 
					...
					home.clickSparcLCPageLogout();
						...
						.verifyOperationalstatusReadOnly(operationalstatus2)
	...
	@DataProvider(name = "LC_Stry000000_Tc06_5")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc06_5");
		return arrayObject;
	}
}
