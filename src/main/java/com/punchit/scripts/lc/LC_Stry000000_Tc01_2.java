...
public class LC_Stry000000_Tc01_2 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc01_2",groups="IncidentManagement")
	public void createIncident(	String regUser, String regPwd, String filterType1,String filterCondition1,
								...
								String text, String systemManager, String operationalstatus, String ciName){
...
//						.clickFirstNamelink()
	...
	@DataProvider(name = "LC_Stry000000_Tc01_2")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc01_2");
		return arrayObject;
	}
}
