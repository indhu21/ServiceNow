...
public class LC_Stry000000_Tc03_5 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc03_5",groups="IncidentManagement")
	public void createIncident( String regUser, String regPwd, String filterType1, String filterCondition1,
								...
								String filterValue4,  String operationalstatus1, String text, String systemManager,
								String changeRequestId,String operationalstatus2, String ciName){
...
//						.clickFirstNamelinkforOracle()
	...
	@DataProvider(name = "LC_Stry000000_Tc03_5")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc03_5");
		return arrayObject;
	}
}
