...
public class LC_Stry000000_Tc04_4 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc04_4",groups="IncidentManagement")
...
//						.clickFirstStoragePoolsNamelink()
	...
	@DataProvider(name = "LC_Stry000000_Tc04_4")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc04_4");
		return arrayObject;
	}
}
