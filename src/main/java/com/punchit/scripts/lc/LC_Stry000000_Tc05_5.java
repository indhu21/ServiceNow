...
public class LC_Stry000000_Tc05_5 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc05_5",groups="IncidentManagement")
...
//						.clickNetworkSwitches()
	...
	@DataProvider(name = "LC_Stry000000_Tc05_5")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc05_5");
		return arrayObject;
	}
}
