...
public class LC_Stry000000_Tc01_5 extends SuiteMethods {

	// Create Instance

	@Test(dataProvider = "LC_Stry000000_Tc01_5",groups="IncidentManagement")
...
//					.clickFirstNamelink()
	...
	@DataProvider(name = "LC_Stry000000_Tc01_5")
	public Object[][] fetchData() throws IOException {
		Object[][] arrayObject = DataInputProvider.getSheet("LC_Stry000000_Tc01_5");
		return arrayObject;
	}
}
